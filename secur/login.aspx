                                                ...
                                                <div style="clear: both;"></div>
                                                    ...
                                                    <div id="theloginform">
                                                        <form name="login" method="post" onsubmit="handleLogin();" action="/processing_login.aspx" target="_top" novalidate="novalidate">
                                                            ...
                                                            <div style="margin-top: 35px;" class="loginbox_container" onclick="document.login.password.focus();" style="">
                                                                ...
                                                                <div class="identity last">
                                                                    <span class="t">
                                                                        <img style="width: 20px; height: 20px;" src="/secur/loginImg/password.png" alt="密码"
                                                                            class="thumbnail" title="密码" /></span><input type="password" placeholder="密码" class="input identityinput" autocomplete="new-password"
                                                                                id="password" name="pw" onblur="validatePwd()" onkeypress="checkCaps(event)"  onkeyup="if(this.value != ''){document.getElementById('clrPw').style.display='block'}else{document.getElementById('clrPw').style.display='none';}" />
                                                                </div>
                                                                <!--
                                                        ...
                                                        -->
                                                            ...
                                                            <div class="loginbox_container">
                                                                <button class="button" id="Login" name="Login">
                                                                    <span class="label">登录到 OA</span></button>
                                                            </div>
