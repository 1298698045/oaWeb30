...
namespace WebClient.secur.identity
{
    public partial class ChangePwd : System.Web.UI.Page
    {
        ...
        void SaveUser()
        {
            ...
            string newPwd2 = Request["confirmpassword"];
            string retURL2 = "";
            if (newPwd != newPwd2)
            {
                retURL2 = "/secur/identity/ChangePwd.aspx";
            ...
            try
            {
                ...
                bool isUpdate = SecurityAuth.ChangePassword(caller, newPwd, newPwd2);
                if (isUpdate)
                {
                    ...
                    retURL2 = string.Format("/home/home.aspx?t=home&token={0}", token);
                    Entity entity = null;
            ...
            catch (OldPasswordNotMatch notMatch)
            {
                ...
                retURL2 = "/home/home.aspx?t=home";
                Supermore.Diagnostics.Trace.LogException(notMatch);
            }
            catch (Exception ex)
            {
