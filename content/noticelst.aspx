...
<head>
    ...
    <style type="text/css">
        ...
        .header-left-title .selectlistcheck li{
            padding-right:0;
        }
    ...
    <script  type="text/javascript">
        ...
        //    window.location = "/apps/scontent/contentManageTab.aspx?t=091&type=100202&src=1";
        //}
    </script>
    <style>
...
<body onunload="if(this.bodyOnUnload)bodyOnUnload();" onbeforeunload="if(this.bodyOnBeforeUnload){var s=bodyOnBeforeUnload();if(s)return s;}" onload="if(this.bodyOnLoad)bodyOnLoad();" class="hasMotif caseTab   ext-gecko ext-gecko3 sfdcBody brandQuaternaryBgr" onfocus="if(this.bodyOnFocus)bodyOnFocus();">
                        ...
                        <div id="bodyWrapper">
                            ...
                            <div class="miss-header">
                                ...
                                <div class="header-left-title">
                                    <p class="header-left-title-name">通知管理</p>
                                    <p class="header-left-title-listname selectinput"><span>我的通知</span><img src="/img/cal/20.png" alt="" /></p>
                                ...
                                <div class="header-right-buttonbtn">
                                    ...
                                    <div>
                                         ...
                                         <input id="dept" onclick="deptchose()" readonly="readonly" style="border:1px solid #dedede;height:32px;line-height:32px;" type="text" name="name" value="">
                                    </div>
                                    <div class="search-group" 
                                        name="StateCode"
                                        id="StateCode"
                                        ...
                                        <div class="selectlist selectlistcheck">
                                            <ul>
                                                <li class="active" value="-1"><img src="/img/cal/checkedgrey.png" /><span>全部</span></li>
                                    ...
                                    <div title="列表控制视图" class="buttonbtn viewlist selectbuttonbtn">
                                        <img class="viewlistimg" src="/img/cal/settings_1.png" alt="设置" />
                                    ...
                                    <div title="筛选器不可用" class="buttonbtn shaixuan ban">
                                        <img src="/img/cal/filterList_2.png" alt="筛选器" />
                                    </div>
                                    <div class="buttonbtn shuaxin neww">
                                        <img src="/img/cal/refresh.png" alt="刷新" />
                                    </div>
                            ...
                            <div class="table-body">
                                ...
                                <script type="text/javascript">
                                    function doSearch(extSrch) {
                                        ...
                                        var filterQuery = "ContentTypeCode\teq\t2";
                                        if (extSrch)
                                            filterQuery += "\n" + extSrch;
                                ...
                                <script type="text/javascript">
                                    ...
                                    $(document).ready(function () {
                                        treeNode = new treeLoader("leftTree", "noticetree", treeItemClick);
                                        treeNode.init();
                                    ...
                                    function formatOper(val, row, index, entityType) {
                                        ...
                                        var html = '<a style=\"color:#015ba7;font-size:13px;\" target=\"_blank\" href=\"/' + entityType + '/detail?objectTypeCode=100202&id=' + rowId + '&retURL=%2f091%2fo\">查看</a>&nbsp;';
                                        ...
                                        html += "&nbsp;|&nbsp;<a style=\"color:#015ba7;font-size:13px;\" target=\"_blank\" href=\"/091/e?objectTypeCode=100202&id=" + rowId + "&retURL=%2f091%2fo\"  >编辑</a>";
                                        //html += "&nbsp;|&nbsp;<a style=\"color:#015ba7;font-size:13px;\" href=\"javascript:void(0)\" onclick=\"renameDialog('" + rowId + "','" + name + "')\" >重命名</a>&nbsp;";
                                        //html += "&nbsp;|&nbsp;<a style=\"color:#015ba7;font-size:13px;\" onclick=\"return confirmDelete();\" href=\"/setup/own/deleteRedirect.aspx?type=100202&delID=" + rowId + "&retURL=%2f091%2fo\">删除</a>";
                                        html += "&nbsp;|&nbsp;<a style=\"color:#015ba7;font-size:13px;\" onclick=deleterow(\"" + rowId + "\",100202) href=\"#\">删除</a>";
                                        return html;
                                    }
                                    ...
                                    function renameDialog(Id, Name) {
                                        ...
                                        var Url = "/common/rename.aspx?Id=" + Id + "&Name=" + Name + "&ObjectTypeCode=" + ObjectTypeCode
    ...
    <script>
        ...
        function deptchose() {
            $('.popup-mask').show()
            $('#changeDiv').show()
            $('#iframe').attr('src', '/alert/deptchose.html').show().height(480).css('margin-top', '-240px')
        }
    </script>
