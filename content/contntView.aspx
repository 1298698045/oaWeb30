...
<head>
    ...
    <title>内容 - 内容详细 ~  - Developer Edition</title>
    ...
    <script type="text/javascript">
        function loadNew()
        {
            if (!commonUtils.isBrowserSupported() || commonUtils.IS_IE8 || commonUtils.IS_IE7)
            {
                ...
                window.location = "/content/contntView_ie8?t=090&amp;objectTypeCode=100202&id=" + id;
            }
        }
        loadNew();
    </script>    
...
<body onunload="if(this.bodyOnUnload)bodyOnUnload();" onbeforeunload="if(this.bodyOnBeforeUnload){var s=bodyOnBeforeUnload();if(s)return s;}" onload="if(this.bodyOnLoad)bodyOnLoad();" class="hasMotif eventTab   ext-gecko ext-gecko3 sfdcBody brandQuaternaryBgr" onfocus="if(this.bodyOnFocus)bodyOnFocus();">
                                    ...
                                    <div class="xiangxinmession ">
                                        <div class="missionmession">
                                            ...
                                            <div class="missionmession-body">
                                                ...
                                                <div class="div-margin">
                                                    <p class="name"><span>栏目</span></p>
                                                    <p class="main" style="margin-left: 10px">
                                                        <span style="line-height: 30px" class="FolderId"></span>
                                                    </p>
                                                    <img src="/img/cal/12.edit_1(14x14).png" />
                                                </div>
                                                <div>
                                                    <p class="name"><span>类型</span></p>
                                                    <p class="main"><span style="line-height: 30px;"class="ContentTypeCode"></span></p>
                                                    <img src="/img/cal/12.edit_1(14x14).png" />
                                                </div>
                                                <div class="div-margin">
                                                    <p class="name"><span>是否公开</span></p>
                                                    <p class="main" style="margin-left: 10px">
                                                        <span style="line-height: 30px" class="IsPublic"></span>
                                                    </p>
                                                    <img src="/img/cal/12.edit_1(14x14).png" />
                                                </div>
                                                <div>
                                                    <p class="name"><span>重要信息</span></p>
                                                    <p class="main"><span style="line-height: 30px;"class="IsImportant"></span></p>
                                                    <img src="/img/cal/12.edit_1(14x14).png" />
                                                </div>
                                                <div class="div-margin">
                                                    <p class="name"><span>置顶</span></p>
                                                    <p class="main" style="margin-left: 10px">
                                                        <span style="line-height: 30px" class="IsTop"></span>
                                                    </p>
                                                    <img src="/img/cal/12.edit_1(14x14).png" />
                                                </div>
                                                <div>
                                                    <p class="name"><span>置顶截止时间</span></p>
                                                    <p class="main"><span style="line-height: 30px;"class="EndTopDate"></span></p>
                                                    <img src="/img/cal/12.edit_1(14x14).png" />
                                                </div>
                                                <div class="div-margin">
                                                    <p class="name"><span>审批状态</span></p>
                                                    <p class="main" style="margin-left: 10px">
                                                        <span style="line-height: 30px" class="StatusCode"></span>
                                                    </p>
                                                    <img src="/img/cal/12.edit_1(14x14).png" />
                                                </div>
                                                <div>
                                                    <p class="name"><span>状态</span></p>
                                                    <p class="main"><span style="line-height: 30px;"class="StateCode"></span></p>
                                                    <img src="/img/cal/12.edit_1(14x14).png" />
                                                </div>
                                                <div class="div-margin">
                                                    <p class="name"><span>部门</span></p>
                                                    <p class="main" style="margin-left: 10px">
                                                        <span style="line-height: 30px" class="BusinessUnitId"></span>
                                                    </p>
                                                    <img src="/img/cal/12.edit_1(14x14).png" />
                                                </div>
                                                <div>
                                                    <p class="name"><span>回执</span></p>
                                                    <p class="main"><span style="line-height: 30px;"class="ReadDetectionFlag"></span></p>
                                                    <img src="/img/cal/12.edit_1(14x14).png" />
                                                </div>
                                                <div class="div-margin">
                                                    <p class="name"><span>发布人</span></p>
                                                    <p class="main" style="margin-left: 10px">
                                                        <span style="line-height: 30px" class="ApprovedBy"></span>
                                                    </p>
                                                    <img src="/img/cal/12.edit_1(14x14).png" />
                                                </div>
                                                <div>
                                                    <p class="name"><span>发布时间</span></p>
                                                    <p class="main"><span style="line-height: 30px;"class="ApprovedOn"></span></p>
                                                    <img src="/img/cal/12.edit_1(14x14).png" />
                                                </div>
                                                <div class="div-margin">
                                                    <p class="name"><span>组织</span></p>
                                                    <p class="main" style="margin-left: 10px">
                                                        <span style="line-height: 30px" class="OrganizationId"></span>
                                                    </p>
                                                    <img src="/img/cal/12.edit_1(14x14).png" />
                                                </div>
                                                <div>
                                                    <p class="name"><span>封皮显示方式</span></p>
                                                    <p class="main"><span style="line-height: 30px;"class="CoverDisplay"></span></p>
                                                    <img src="/img/cal/12.edit_1(14x14).png" />
                                                </div>
                                                <div class="div-margin">
                                                    <p class="name"><span>附件权限</span></p>
                                                    <p class="main" style="margin-left: 10px">
                                                        <span style="line-height: 30px" class="AttachRightCode"></span>
                                                    </p>
                                                    <img src="/img/cal/12.edit_1(14x14).png" />
                                                </div>
                                        ...
                                        <div class="">
                                            ...
                                            <div class="missionmession-body">
                                                ...
                                                <div class="rightdiv">
                                                    <p class="name "><span>评论数量</span></p>
                                                    <p class="main" style="margin-left: 10px">
                                                        <span style="margin-left: 20px"class="blue HostName"></span>
                                                    </p>
                                                </div>
                                                <div>
                                                    <p class="name"><span>不喜欢数量</span></p>
                                                    <p class="main" style="margin-left: 10px">
    ...
    <script>
        ...
        $('.megtixing').click(function () {
            $('#changeDiv').show()
            $('#iframe').attr('src', '/alert/cntrt/add_tixing.html').show()
        })
        //备注
        $('.mask').click(function () {
            $('#changeDiv').show()
            $('#iframe').attr('src', '/alert/remarks.html?parentId=' + metid + '&objTypeCode=' + 100201).show()
        })
        //编辑会议
        $('.megedit').click(function () {
            window.location.href = '/090/e?id=' + metid
        })
        //更改状态
        $('.changestatus').click(function () {
            $('#changeDiv').show()
            $('#iframe').attr('src', '/alert/changestatus.html').show()
        })
        //新建议题
        ...
        function deletedept(id) {
            $('#iframe').attr('src', '/alert/delete.html?id=' + id + '&objTypeCode=20023');
            $('#changeDiv').show();
            $('#iframe').show();
        }
        ...
        function getdata() {
            ...
            function callback(data) {
                ...
                $('.contract-message ul').eq(1).find('li').eq(0).html(FolderId)
                $('.contract-message ul').eq(1).find('li').eq(1).html(ContentTypeCode)
                $('.contract-message ul').eq(1).find('li').eq(2).html(KeyWords)
                $('.contract-message ul').eq(1).find('li').eq(3).html(StateCode)
                $('.Title').html(Title)
        ...
        $('.summaryedit').click(function () {
            $('#iframe').attr('src', '/alert/content_form.html?objTypeCode=5004');
            $('#changeDiv').show();
            $('#iframe').show();
        })
        //发布
        $('.megfabu').click(function () {
            $('#iframe').attr('src', '/alert/fabu.html?id='+ metid);
            $('#changeDiv').show();
            $('#iframe').show();
        })
        //预览
        $('.preview').click(function () {
            window.open('/apps/scontent/PreviewContent.aspx?id=' + metid)
        })
        //添加分类
        $('.addclass').click(function () {
            $('#iframe').attr('src', '/alert/add_class.html?');
            $('#changeDiv').show();
            $('#iframe').show();
        })
        //获取分类
        ...
        function getclass() {
            ...
            ajaxMethodGetData('content.category.list', d, function (data) {
                ...
                $('.old-fl .megti-delete').click(function(){
                    var id = $(this).attr('id')
                    $('.selectlist').hide()
                    $('#iframe').attr('src', '/alert/delete.html?id=' + id + '&objTypeCode=100210');
                    $('#changeDiv').show();
                    $('#iframe').show();
                    return false
                })
