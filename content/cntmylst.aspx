...
<head>
    ...
    <link href="/easyui/themes/icon.css" rel="stylesheet" type="text/css" />
    <script type="text/javascript" src="/easyui/js/treeLoader.js?a=1"></script>
                        ...
                        <div id="bodyWrapper">
                            ...
                            <div class="miss-header">
                                ...
                                <div class="header-left-title">
                                    <p class="header-left-title-name">信息管理</p>
                            ...
                            <div class="table-body">
                                <div class="objectManagerLeftNav" style="padding-top: 0; height: 100%; padding-bottom: 0px;width:100%;">
                                ...
                                <script type="text/javascript">
                                    ...
                                    function bindGrid(filterQuery, search) {
                                        ...
                                        fcols.push({ field: "ReadCount", title: '阅读数量123', sortable: true });
                                ...
                                <script type="text/javascript">
                                    ...
                                    function formatOper(val, row, index, entityType) {
                                        ...
                                        html += "&nbsp;|&nbsp;<a style=\"color:#015ba7;font-size:13px;\" target=\"_blank\" href=\"/090/e?id=" + rowId  +"&retURL=%2F090%2Fo" + "\"  >编辑</a>";
                                        ...
                                        html += "&nbsp;|&nbsp;<a style=\"color:#015ba7;font-size:13px;\" onclick=deleterow(\"" + rowId + "\",100201) href=\"#\">删除</a>";
                                        return html;
                                    }
