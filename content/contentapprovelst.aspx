                            ...
                            <div class="table-body">
                                ...
                                <script type="text/javascript">
                                    ...
                                    function bindGrid(filterQuery, search) {
                                        ...
                                        fcols.push({ field: "ApprovedOn", title: '发布时间', sortable: false });
                                        //被考评部门
                                        url = "/apps/CommandProcessor.ashx?cmd=content.waitapprove.search";
                                        if (!search)
                                            search = "";
                                        $('#datagrid').datagrid({
                                            url: url,
                                ...
                                <script type="text/javascript">
                                    ...
                                    function formatOper(val, row, index, entityType) {
                                        var rowId = row["ContentId"]; //return '<a style=\"color:#015ba7;font-size:13px;\" href="e?id=' + rowId + '">修改</a>&nbsp;|&nbsp;<a style=\"color:#015ba7;font-size:13px;\" href=\"/setup/own/deleteRedirect.aspx?objectType=&delID=' + rowId + '&retURL=\">删除</a>';
