...
<head>
    ...
    <title>信息编辑: <%=CTitle%> ~  - 知识管理 - 高效协同</title>
    <!--
            ...
            <table class="outer" width="100%" id="bodyTable" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td class="oRight" id="bodyCell">
                                        ...
                                        <table class="detailList" border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                ...
                                                <td class="dataCol col02">
                                                    ...
                                                    </select><input type="checkbox" name="publishHome" id="publishHome" onclick="if(this.checked) {document.getElementById('coverDisplay').options[3].selected=true;}" />发送到首页展播
                                                </td>
                        ...
                        <script type="text/javascript">
                            function delCoverImg(id,contentid)
                            {
                                deleteMediaImg(id,contentid,refImgContainer);
                            }
                            function refImgContainer(data)
                            {
                                window.location.reload();
                            }
                            function delCoverAttach(id)
                            {
                                alert(111);
                                deleterRelatedAttachment(id,refAttachContainer);
                            }
                            function refAttachContainer(data)
                            {
                                window.location.reload();
                            }
                        </script>
