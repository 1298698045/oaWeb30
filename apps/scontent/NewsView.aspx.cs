    ...
    public partial class NewsView : System.Web.UI.Page
    {
        ...
        void GetData()
        {
            ...
            //this.PreviewURL = Supermore.Configuration.Settings.GetSetting("Sites.Portal") + "ViewNotice.aspx?id=" + strId;
             ...
             //this.PreviewURL = "/portal/viewArticle.html?ispreview=1&contentid=" + strId;
            ...
            Entity itemTree = EntityManager.GetEntity(caller, EntityTemplateIDs.ItemTree, new Guid(FolderId));
            this.FolderName = itemTree.Name;
            ...
            {
                Guid createUser = new Guid(caller.UserID);
                if (entity.CreatedBy == createUser)
                {
        ...
        void RenderNoteList(string objectId, string objectName)
        {
            ...
            noteList.EntityTemplateCode = ObjectTypeCodes.Content;
            noteList.Caller = caller;
            noteList.RetURL =HttpUtility.UrlEncode(this.Request.RawUrl);
            noteList.Render();
        ...
        {
            EntityCollection collection = ContentManager.GetContentReaders(caller, new Guid(objectId), 1,"", 100, 1);
            int mode = 2;
