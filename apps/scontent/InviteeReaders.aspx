<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InviteeReaders.aspx.cs" Inherits="WebClient.apps.scontent.InviteeReaders" %>
...
<head>
    <title>通知编辑 - <%=PageTitle%>  ~ .com - Developer Edition</title>
                ...
                <tr>
                    ...
                    <td id="bodyCell" class="oRight"><a name="skiplink">
                        <img width="1" height="1" title="内容在此开始" class="skiplink skipLinkTargetInner zen-skipLinkTarget" alt="内容在此开始" src="/s.gif"></a><div class="bPageTitle">
                            <div class="ptBody">
                                <div class="content">
                                    <img title="" class="pageTitleIcon" alt="" src="/s.gif"><h1 class="pageType">邀请查看者<span class="titleSeparatingColon">:</span></h1>
                                    <h2 class="pageDescription">邀请查看者：<%=PageTitle%></h2>
                                    <div class="blank">&nbsp;</div>
                                </div>
                                <div class="links"></div>
                            </div>
                        ...
                        <form onsubmit="javascript:saveAllSelected([ document.editPage.duel_select_0, document.editPage.duel_select_1 ], [ document.editPage.duel0, document.editPage.duel1 ], ',', '\\', '--无--');if (window.ffInAlert) { return false; }" name="editPage" method="post" id="editPage" action="/apps/scontent/InviteeReaders.aspx?t=091">
                            ...
                            <div id="ep" class="bPageBlock brandSecondaryBrd bEditBlock bLayoutBlock secondaryPalette">
                                <div class="pbHeader">
                                    <table cellspacing="0" cellpadding="0" border="0">
                                        <tbody>
                                            <tr>
                                                <td class="pbTitle">
                                                    <img width="1" height="1" title="" class="minWidth" alt="" src="/s.gif"><h2 class="mainTitle">邀请查看者</h2>
                                                </td>
                                ...
                                <div class="pbBody">
                                    ...
                                    <div id="head_1_ep" class="brandTertiaryBgr first pbSubheader tertiaryPalette">
                                        <span class="pbSubExtra"><span class="requiredLegend brandTertiaryFgr"><span class="requiredExampleOuter"><span class="requiredExample">&nbsp;</span></span><span class="requiredMark">*</span><span class="requiredText"> = 必填信息</span></span></span><h3>编辑查看者<span class="titleSeparatingColon">:</span></h3>
                                    </div>
                                                ...
                                                <tr class="last detailRow">   
                                                    <td colspan="4">
                                                     ...
                                                     <td align="left" style="width:30%">
                                                        <span style="color:red;font-weight:bold;">排除组、角色成员：勾选排除成员！</span><br />
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            function getGroupRoleUsers() {
                                                ...
                                                $("#duel_select_1 option").each(function () {
                                                    ...
                                                    seleValue = $(this).val(); //这里得到的就是
                                                    //alert(seleValue);
                                                    var seleText = $(this).text();
                                                    var pref = seleValue.substr(0, 1);
                                                    //alert(pref)
                                                    if (pref != "U") {
                                                        html1 += " <div style='font-weight:bold;'>" + seleText + "</div>";
                                                        html1 += "<div>";
                                                        if (seleValue != "")
                                                            listGroupRoleUsers(seleValue);
                                                        html1 += "</div>";
                                                        i++;
                                                    }
                                                });
                                            ...
                                            function listGroupRoleUsers(seleValue) {
                                                ...
                                                var d = { id: seleValue };
                                                ajaxMethodData("group.user.getlist", d, function (data) {
                                                    html1 += "<div style='list-style-type:none;'>";
                                                    html1 += "<div class='row' style='margin-top:5px;'>";
                                                    var c = 0;
                                                    for (var l = 0; l < data.listData.length; l++) {
                                                        if (c >= 5) {
                                                            html1 += "</div>";
                                                            html1 += "<div class='row' style='margin-bottom:5px;'>";
                                                            c = 0;
                                                        }
                                                        var row = data.listData[l];
                                                        //html1 += "<li>"+row.name+"</li>";
                                                        html1 += "<div  style='display:inline;margin-left:5px;'><input type='checkbox' value=\"" + row.id + "\" name=\"groupUser\" />" + row.name + "</div>";
                                                        c++;
                                                    }
                                                    html1 += "</div>";
                                    ...
                                    <div class="pbSubheader brandTertiaryBgr first tertiaryPalette" id="head_2_ep">
                                        <span class="pbSubExtra"><span class="requiredLegend brandTertiaryFgr"><span class="requiredExampleOuter">
                                            <span class="requiredExample">&nbsp;</span></span><span class="requiredMark">*</span><span
                                                class="requiredText"> </span></span></span><h3>通知查看者<span class="titleSeparatingColon">:</span></h3>
                                    </div>
                                    <div class="pbSubsection">
                                        <table class="detailList" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td colspan="3" class="data2Col">
                                                    <div class="requiredInput">
                                                        <div class="requiredBlock"></div>
                                                        <input type="text" size="70" name="p6" maxlength="100" id="p6" value="<%=ContentTitle%>"></div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="labelCol">
                                                    <label for="con20">
                                                        ...
                                                        通知短信内容</label><div class="textCounterOuter">
                                            ...
                                            <tr class="detailRow">
                                                ...
                                                <td colspan='3'>
                                                    <input id="sendMail" name="sendMail" type="checkbox" value="1" checked="checked" /><label
                                                        for="sendMail">发送APP推送、IM系统消息 提醒</label>
                                                </td>
                                            </tr>
                                            <tr class="last detailRow">
                                                <td></td>
                                                <td colspan='3'>
                                                    <input id="sendSms" name="sendSms" type="checkbox" value="1"  /><label
                                                        for="sendMail">发送手机短信 提醒</label>
                                                </td>
                                            </tr>
                                           <!--<tr class="detailRow">
                                                <td class="last labelCol">短信通知范围</td>
                                                <td colspan='3'>
                                                    <input id="inviteeAll" name="inviteeAll" type="checkbox" value="1"  /><label
                                                        for="inviteeAll">消息通知所有人员查看</label>
                                                </td>
                                            </tr>-->
                                        </table>
                                    </div>
