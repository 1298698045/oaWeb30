...
<head>
    <title>通知编辑 - <%=CTitle%>  ~ 知识管理 - 高效协同</title>
...
<body onload="if(this.bodyOnLoad)bodyOnLoad();" onunload="if(this.bodyOnUnload)bodyOnUnload();"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="pbButton " id="thePage:mainLayout:formIdea:pb:pbb">
                                                                    <input type="submit" class="btn btn ideaPostBtn" value="保存发布" title="保存发布" id="save_top" name="save" style="height: 25px;" />
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="dataCol col02">
                                                                          ...
                                                                          <td class="labelCol ">显示顺序
                                                                            </td>
                                                                            <td class="dataCol col02">                                                  
                                                                                <input type="text" name="Position" id="Position" size="10" value="<%=Position%>" />
                                                                            </td>
                                                                    </tr>
                                                                    <tr>
                                                        ...
                                                        <div class="pbSubsection">
                                                            <table class="detailList" border="0" cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    ...
                                                                    <td class="data2Col" colspan="3">
                                                                        <input type="checkbox" id="chkIsPublic" name="chkIsPublic" <%=this.PublicHTML%> />所有人可以查看（不勾选就部分人可以查看）
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                               ...
                                                               <input type="hidden" id="readers" name="readers" value="<%=Readers%>" />
   				                                                ...
   				                                                <tr>
                                                                    <td class="labelCol empty">提醒
                                                                    </td>
                                                                    <td class="data2Col" colspan="3">
                                                                        <input type="checkbox" id="chkRemindSms" name="chkRemindSms" checked="checked" />短信提醒
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </div>
                                                                    ...
                                                                    <td class="dataCol col02">
                                                                        <select name="coverDisplay" id="coverDisplay">
                                                                            <option value="">--选择--</option>
                                                                             <option value="BelowTitleBigImg" selected="selected">标题下面大图</option>
                                                                        ...
                                                                        <input type="checkbox" name="publishHome" id="publishHome" onclick="if(this.checked) {document.getElementById('coverDisplay').options[3].selected=true;}" />发送到首页展播
                                                                    </td>
                                                        ...
                                                        <div class="pbSubsection">
                                                            <table class="detailList" border="0" cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    ...
                                                                    <td class="labelCol empty">&nbsp;
                                                                        <span style="color:red;display:none;">注意：保存后还可以继续添加更多附件！！！</span>
                                                                    </td>
                                                                    <td class="dataCol empty">&nbsp;
                                                                    </td>
                                                                </tr>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="pbButtonb " id="thePage:mainLayout:formIdea:pb:pbb:bottom">
                                                                    ...
                                                                    <input value=" 取消 " class="btn" title="取消" name="cancel" type="button" style="height: 25px;" onclick="navigateToUrl('retURL', 'EditPage', 'cancel');" />
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
    ...
    <script>        // var SFDCSessionVars = { "uid": "0059000000390Wh", "exp": 1428421640000, "host": "login..com", "oid": "00D90000000yvHG", "server": "https://login..com/login/sessionserver190.html", "act": "u" };</script>
