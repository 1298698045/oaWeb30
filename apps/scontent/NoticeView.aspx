<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NoticeView.aspx.cs" Inherits="WebClient.apps.scontent.NoticeView" %>
...
<head>
    ...
    <title>通知：<%=Title%> ~ .com - Developer Edition
    </title>
                        ...
                        <a name="skiplink">
                            <img src="/s.gif" height='1' width='1' alt="内容在此开始" class="skiplink skipLinkTargetInner zen-skipLinkTarget"
                                title="内容在此开始" /></a><div class="bPageTitle">
                                    <div class="ptBody">
                                        <div class="content">
                                            <img src="/s.gif" alt="通知" class="pageTitleIcon" title="通知" /><h1 class="pageType noSecondHeader">
                                                通知：<%=Title%></h1>
                                            <div class="blank">
                                                &nbsp;</div>
                                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pbButton" id="topButtonRow">
                                            ...
                                            <div class="menuButton" id="inviteeDetail">
                                                <div class="menuButtonButton" id="inviteeDetailButton"><span class="menuButtonLabel" id="inviteeDetailLabel" tabindex="2">邀请查看</span></div>
                                                <div class="menuButtonMenu" id="inviteeDetailMenu"><a href="/apps/scontent/InviteeReaders.aspx?t=091&type=100202&amp;id=<%=EntityId%>&retURL=%2F091%2Fdetail?id=<%=EntityId%>" class="menuButtonMenuLink firstMenuItem">邀请查看 - 分组</a><a href="/content/notice/mem/SelectSearch?addTo=<%=EntityId%>"  class="menuButtonMenuLink">邀请查看 - 搜索</a></div>
                                            </div>
                                            <script>     new MenuButton('inviteeDetail', false);</script>-->                                            
                                            <input value=" 邀请查看人员 " class="btn" title="邀请查看人员" name="invitee" onclick="navigateToUrl('/apps/scontent/InviteeReaders.aspx?t=091&type=100202&amp;id=<%=EntityId%>&retURL=%2F091%2Fdetail?id=<%=EntityId%>    ','DETAIL','invitee');"
                                                type="button" />
