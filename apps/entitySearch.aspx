<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="entitySearch.aspx.cs" Inherits="WebClient.apps.entitySearch" %>
...
<body onload="if(this.bodyOnLoad)bodyOnLoad();" onunload="if(this.bodyOnUnload)bodyOnUnload();"
    class="hasMotif reportTab SelectSearch  ext-gecko ext-gecko3 sfdcBody brandQuaternaryBgr"
            ...
            <table class="outer" width="100%" id="bodyTable" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td class="oRight" id="bodyCell">
                        ...
                        <a name="skiplink">
                            <img src="/s.gif" height='1' width='1' alt="内容在此开始" class="skiplink skipLinkTargetInner zen-skipLinkTarget"
                                title="内容在此开始" /></a><div class="bPageTitle">
                                    <div class="ptBody">
                                        <div class="content">
                                            <img src="/s.gif" alt="搜索" class="pageTitleIcon" title="搜索" /><h1 class="pageType noSecondHeader">
                                               <%=PageTitle%></h1>
                                            <div class="blank">
                                                &nbsp;</div>
                                        </div>
                        ...
                        <form action="/_ui/entity/search/EntitySearchResults" id="editPage" method="post"
                        name="editPage" onsubmit="if (window.ffInAlert) { return false; }">     
                        ...
                        <div class="pricebookentryBlock">
                            <div class="bPageBlock brandSecondaryBrd">
                                <div class="pbHeader" id="lineItemView_searchHeader">
                                    <table border="0" cellpadding="0" cellspacing="0" summary="公文">
                                       <!--<tr>
                                            <td class="pbTitle">
                                            ...
                                            <td class="pbHelp">
                                                <span class="searchCustomization">
                                                    <div class="menuButton" id="comboButtonPricebookEntry"><div class="menuButtonButton" id="comboButtonPricebookEntryButton"><span class="menuButtonLabel" id="comboButtonPricebookEntryLabel" tabindex="0">自定义...</span></div>
                                                        <div class="menuButtonMenu" id="comboButtonPricebookEntryMenu">
                                                            <a href="/p/setup/layout/ListLayoutEdit?retURL=%2F_ui%2Fbusop%2Forderitem%2FSelectSearch%3FaddTo%3D80190000000PJyk%26retURL%3D%252F80190000000PJyk&amp;LayoutType=SearchResult&amp;LayoutEntity=PricebookEntry&amp;fromCustomizeButton=1&amp;setupid=PricebookEntrySearchLayouts"
                                                    ...
                                                    <table class="searchFilterFields">
                                                        <tr>
                                                            <td class="keywordElement" style="width: 5%">
                                                                <span class="inputTitle">按关键字</span><br />
                                                            ...
                                                            <td>
                                                                <span class="inputTitle">按字段筛选条件</span><br />
                                                                 <%=SearchLineHTML%>                                                             
                                                                <script type="text/javascript">
                                                                    var oppLabels = new Array(); oppLabels['eq'] = '等于'; oppLabels['neq'] = '不等于'; oppLabels['lt'] = '小于'; oppLabels['gt'] = '大于'; oppLabels['le'] = '小于或等于'; oppLabels['ge'] = '大于或等于'; oppLabels['beginswith'] = '起始字符'; oppLabels['contains'] = '包含'; oppLabels['not-like'] = '不包含'; oppLabels['in'] = '在范围内'; oppLabels['not-in'] = '不在范围内'; 
                                                                    var allOperators = ['eq', 'neq', 'lt', 'gt', 'le', 'ge', 'in', 'not-in', 'contains', 'not-like', 'beginswith'];
                                                                    var noneLabel;
                                                                    function updateOperator(sel, opSelName, lookupName) {
                                                                        var selObj = document.getElementById(opSelName);
                                                                        if (selObj.offsetWidth > 0) { selObj.style.width = selObj.offsetWidth + 'px'; }
                                                                        if (noneLabel == null && selObj.options[0].value.length == 0) noneLabel = selObj.options[0].text; var ops = null;
                                                                        ...
                                                                        if (lookupName) {
                                                                            if (val2type[val.value] == 'StaticEnum' || val2type[val.value] == 'DynamicEnum' || val2type[val.value] == 'EnumOrId' || val2type[val.value] == 'Division' || val2type[val.value] == 'RecordType' || val2type[val.value] == 'Boolean')
                                                                    ...
                                                                    function initializeOperator(selName, colName, lookupName)
                                                                    {
                                                                        ...
                                                                        if (obj) { obj = document.getElementById(selName); if (obj != null) { updateOperator(obj, colName, lookupName); } }
                                                                    }
                                                                    function onLoadCriteria() {
                                                                        ...
                                                                        initializeOperator('PricebookEntrycol5', 'PricebookEntryoper5', null);
                                                                    }
                                                                </script>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td colspan="3">
                                                                <div class="searchFilterButtons productButtons">
                                                                    <input value=" 搜索 " class="btn" id="save_filter_PricebookEntry" name="saveButton"
                                                                        ...
                                                                        title="搜索" type="button" /><input type="button" title="另存为" onclick="    document.getElementById('isSaveAs').value = '1'; return exportDownload();" name="save" class="btn" value=" 导出另存为 " data-uidsfdc="6" /></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                        ...
                        <script type="text/javascript" >
                            function getFilterCondition() {
                                ...
                                //debugger;
                                for (a = 0; a < f; a++) {
                                   // var g = 'fop' + a, h = 'fval' + a;
                                   // c = document.getElementById('fcol' + a).value;//col
                                   // g = document.getElementById(g).value;//operator
                                   // h = document.getElementById(h).value;//value
                                    
                                    var g = 'PricebookEntryoper' + a, h = 'PricebookEntryfval' + a;
                                    c = document.getElementById('PricebookEntrycol' + a).value;//col
                                    g = document.getElementById(g).value;//operator
                                    h = document.getElementById(h).value;//value
    ...
    <script>        var SFDCSessionVars = { "uid": "0059000000390Wh", "exp": 1437560002000, "host": "login..com", "oid": "00D90000000yvHG", "server": "https://login..com/login/sessionserver190.html", "act": "u" };</script>    
