...
{
    public partial class DocSrch : System.Web.UI.Page
    {
        CallContext _caller;
        int _pageSize = 25;
        string _initJson = "";
        ...
        public void GetEntityList()
        {
           ...
           // _template = savedQuery.Template;
            ...
            string docOut = "/_ui/busop/docoutitem/DocOutItemListServlet";
            string docIn="/_ui/busop/docinitem/DocInItemListServlet";
            if (_templateCode == "A08")
            {
                _initJson = "new LineItemListViewport('lineItemView', 'PricebookEntry'," + dataJson + ", '80190000000PJyk', '" + docIn + "');";
            }
            else
            {
                _initJson = "new LineItemListViewport('lineItemView', 'PricebookEntry'," + dataJson + ", '80190000000PJyk', '" + docOut + "');";
            }
