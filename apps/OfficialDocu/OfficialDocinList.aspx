<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OfficialDocinList.aspx.cs" Inherits="WebClient.apps.OfficialDocu.OfficialDocinList" %>
...
<head>
    ...
    <link href="/sCSS/33.0/sprites/1424976646000/Theme3/zh/base/ExtCSS-SFDC.css" rel="stylesheet"
        type="text/css" />
    <link href="/sCSS/32.0/sprites/1420068168000/Theme3/zh/base/CampaignManageMembers.css"
...
<body onload="if(this.bodyOnLoad)bodyOnLoad();" onunload="if(this.bodyOnUnload)bodyOnUnload();"
    class="hasMotif contractTab  CampaignManageMembersAddTab   ext-gecko ext-gecko3 sfdcBody brandQuaternaryBgr"
                    ...
                    <tr>
                        ...
                        <td id="bodyCell" class="oRight">
                            ...
                            <div class="bPageTitle">
                                <div class="ptBody">
                                    <div class="content">
                                        <img title="我的事务" class="pageTitleIcon" alt="我的事务" src="/s.gif" /><h1 class="pageType">
                                            公文管理<span class="titleSeparatingColon">:</span></h1>
                                ...
                                <div id="save_error" class="message errorM3" style="display: none;"><table cellspacing="0" cellpadding="0" border="0" class="messageTable"><tbody><tr><td><img title="错误" class="msgIcon" alt="错误" src="/s.gif"></td><td class="messageCell"><div class="messageText"><h4>保存更改时出现错误。</h4><span id="save_error_text"></span></div></td></tr></tbody></table></div>
                               <!-- <div id="queueTabs" class="miniTab secondaryPalette">                                    
                                    <ul class="miniTabList">
                                        <li class="currentTab"><a onclick="return BaseAssociation.warnUnsavedData();" title="由我发起 创建的事务 子选项卡" id="associationQueueContactTab" href="/122/o?src=1">我发起事务</a></li>
                                        <li class="secondaryPalette"><a onclick="return BaseAssociation.warnUnsavedData();" title="别人发起,流转到我办理的事务 子选项卡" id="associationQueueEventTab" href="/122/o?src=2">事务办理</a></li>
                                ...
                                <div class="queueHeaderLinkDiv">
                                    <a onclick="SfdcApp.BaseAssociation.SmartRecommender.toggleWhatRecommendation(true);"
                                        id="whatRecommenderOffId" class="queueHeaderLink" href="javascript:void(0)">管理事务</a><a
                                            style="display: none" onclick="SfdcApp.BaseAssociation.SmartRecommender.toggleWhatRecommendation(false);"
                                            id="whatRecommenderOnId" class="queueHeaderLink" href="javascript:void(0)">打开推荐</a><a
                                                onclick="return BaseAssociation.detailPagePopup('/email/admin/emailToSalesforceUserEdit.aspx', 'My Email 至 Salesforce');"
                                                class="queueHeaderLink" href="/email/admin/emailToSalesforceUserEdit.aspx">至 设置</a>
                                </div>
                                        ...
                                        <td>
                                            <div>
                                                <div class="bSubBlock brandSecondaryBrd secondaryPalette">
                                                    ...
                                                    <div class="lbBody"><!--
                                                        <ul>
                                                            <li><a href="/00O?rt=4&amp;retURL=%2F701%2Fo&amp;t=title1&amp;scope=user&amp;c=CAN&amp;c=CTY&amp;c=CST&amp;c=START_DATE&amp;c=CNS&amp;c=CNR&amp;c=NOP&amp;c=NWO&amp;c=AWO&amp;c=CAC&amp;c=ROI&amp;c=AVGCOST_CUST&amp;c=AVGCOST_RESP&amp;details=yes">
                                                                市场活动投资回报率分析报表</a></li><li><a href="/00O?rt=8&amp;retURL=%2F701%2Fo&amp;format=x&amp;break0=CTY&amp;break0a=CAN&amp;break1=MEMBER_STATUS&amp;scope=user&amp;c=CAN&amp;c=MEMBER_STATUS&amp;details=yes">
                                                                    市场活动成员分析报表</a></li><li><a href="/00O?rt=9&amp;retURL=%2F701%2Fo&amp;t=title12&amp;open=closedwon&amp;break0=CAMPAIGN_NAME&amp;c=FN&amp;c=AN&amp;c=ON&amp;c=SN&amp;c=FQ&amp;c=CD&amp;c=TY&amp;c=CAMPAIGN_NAME&amp;s=AM&amp;a=AG&amp;details=yes&amp;format=t">
                                                                        市场活动收入报表</a></li></ul>-->
                                                    </div>
                                                </div>
                                            </div>
