<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocSrch.aspx.cs" Inherits="WebClient.apps.OfficialDocu.DocSrch" %>
...
<body onload="if(this.bodyOnLoad)bodyOnLoad();" onunload="if(this.bodyOnUnload)bodyOnUnload();"
    class="hasMotif <%=TabCss%>  SelectSearch  ext-gecko ext-gecko3 sfdcBody brandQuaternaryBgr"
                ...
                <tr>
                    ...
                    <td class="oRight" id="bodyCell">
                        ...
                        <div class="bOverviewSearch">
                            <div class="view">
                                输入关键字和筛选条件，然后单击“搜索”以开始搜索。单击“更多筛选器”以使用一个以上的筛选器。搜索结果包括与所输入关键字和筛选条件匹配的所有记录。</div>
                        </div>
                        <form action="/_ui/busop/orderitem/MultiOrderItemEdit" id="dispatch" method="post"
                        name="dispatch" onsubmit="if (window.ffInAlert) { return false; }">                        
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <script type="text/javascript">
                                                                    ...
                                                                    var allOperators = ['eq', 'neq', 'lt', 'gt', 'le', 'ge', 'contains', 'not-like', 'beginswith'];
                                                                    var noneLabel;
                                                                    function updateOperator(sel, opSelName, lookupName) {
                                                                        ...
                                                                        if (lookupName) {
                                                                            if (val.value == 'Case.BusinessHours' || val.value != 'MEMBER_STATUS' && val.value != 'CAMPAIGN_MEMBER.STATUS' && val.value != 'Lead.CampaignMemberStatus' && val2type[val.value] == 'StaticEnum' || val2type[val.value] == 'DynamicEnum' || val2type[val.value] == 'EnumOrId' || val2type[val.value] == 'Division' || val2type[val.value] == 'RecordType' || val2type[val.value] == 'Boolean')
