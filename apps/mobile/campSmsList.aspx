<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="campSmsList.aspx.cs" Inherits="WebClient.apps.mobile.campSmsList" %>
...
<body onload="if(this.bodyOnLoad)bodyOnLoad();" onunload="if(this.bodyOnUnload)bodyOnUnload();"
    ...
    <div  id="contentWrapper">
            ...
            <table class="outer" width="100%" id="bodyTable" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td class="oRight" id="bodyCell">
                                ...
                                <span class="bFilter">
                                    <label for="fcf" style="text-align: left; font-weight: bold; padding-right: .69em;">
                                        <span class="requiredMark">*</span>视图：</label><span class="fBody"><select id="fcf"
                                            name="fcf" onchange="javascript:this.form.submit();" title="视图：">
                                            <!--<option value="00B90000008ViBi"> New Last Week</option>                                                
                                    ...
                                    <div class="pbHeader">
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td class="pbButton"><!--
                                                    <input value=" 新建群发短信 " class="btn" name="new" onclick="navigateToUrl('/apps/mobile/SendSmsStage.aspx?t=705&retURL=%2F705%2Fo', null, 'new');"
                                                        title="新建群发短信" type="button" style="height:25px;" />-->
                                                     <input value=" 新建短信发送 " class="btn" name="new" onclick="navigateToUrl('/apps/mobile/SmsMsgEdit.aspx?t=705&retURL=%2F705%2Fo', null, 'new');"
                                                        title="新建短信发送" type="button" style="height:25px;" />
                                                </td>
                                                <td class="pbHelp"><!--
                        ...
                        <table class="toolsContent" id="toolsContent" style="display:block">
                            <tr>
                                <td><!--
                                ...
                                <td>
                                    <div class="toolsContentRight">
                                        <div class="bSubBlock brandSecondaryBrd secondaryPalette">
                                            ...
                                            <div class="lbBody">
                                                <ul>
                                                    <li><span><a href="/apps/mobile/SmsLogs.aspx?t=705">发送记录日志查询</a></span></li></ul>
                                            </div>
                                        </div>
                                    </div>
                                </td>
        ...
        <div class="bPageFooter noTableFooter">
            <div>
                <span class="brandQuaternaryFgr">Copyright © 2000-2014 .com, inc. 公司版权所有。保留所有权利。</span>&nbsp;|&nbsp;<a
                    ...
                    target="_blank" title="隐私声明 （新窗口）">隐私声明</a>&nbsp;|&nbsp;<a href="http://www..com/company/security.jsp"
                        class="brandQuaternaryFgr" target="_blank" title="安全声明 （新窗口）">安全声明</a>&nbsp;|&nbsp;<a
                            ...
                            title="使用条款 （新窗口）">使用条款</a>&nbsp;|&nbsp;<a href="javascript:openPopupFocusEscapePounds('', 'Help', 1024, 768, 'width=1024,height=768,resizable=yes,toolbar=yes,status=yes,scrollbars=yes,menubar=yes,directories=no,location=yes,dependant=no', false, false);"
