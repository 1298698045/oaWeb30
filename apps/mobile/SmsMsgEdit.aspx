<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SmsMsgEdit.aspx.cs" Inherits="WebClient.apps.mobile.SmsMsgEdit" %>
...
<body onload="if(this.bodyOnLoad)bodyOnLoad();" onunload="if(this.bodyOnUnload)bodyOnUnload();"
            ...
            <table class="outer" width="100%" id="bodyTable" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td class="oRight" id="bodyCell">
                        ...
                        <form action="/705/e" id="editPage" method="post" name="editPage" onsubmit="if (window.ffInAlert) { return false; } if (!validateForm()) { return false; } if (window.sfdcPage && window.sfdcPage.disableSaveButtons) { return window.sfdcPage.disableSaveButtons(); }">
                            <input type="hidden" name="cancelURL" id="cancelURL" value="/705/o" /><input type="hidden"
                                name="retURL" id="retURL" value="/705/o" /><input type="hidden" name="save_new_url"
                                    id="save_new_url" value="/705/e?retURL=%2F705%2Fo" /><div class="bPageBlock brandSecondaryBrd bEditBlock secondaryPalette"
                                        id="ep">
                                        <div class="pbHeader">
                                                    ...
                                                    <td>
                                                        <table class="detailList" border="0" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                ...
                                                                <td class="dataCol col02">
                                                                    <div class="requiredInput">
                                                                        ...
                                                                        <input id="Name" maxlength="120" name="Name" size="40" tabindex="1" type="text" value="<%=SmsName%>" />
                                                                    </div>
                                                                </td>
                                                                <td class="labelCol">
                                                                    <label>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="dataCol col02">
                                                                    <label style="color: red" id="lblsmscredit">
                                                                        -</label>
                                                                    条
                                                        <input type="hidden" value="0" id="smscredit" name="smscredit" />
                                                                    <!--<input type="button" class="btn-small" value="充值" title="充值短信" onclick="window.location='/Accounts/viewPricing.aspx?pageName=account.home&amp;activepage=account.home'">-->
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="dataCol col02">
                                                                    <select onchange="msgtemplatechange()" id="msgtemplate">
                                                                    </select>
                                                                    <span style="color:#108def;cursor:pointer;" onclick="deletetemplate()">删除选中的模板</span>
                                                                    <span style="color:#108def;cursor:pointer;margin-left:10px;" onclick="edittemplate()">编辑选中的模板</span>
                                                                    <span style="color:#108def;cursor:pointer;margin-left:10px;" onclick="addtemplate()">添加新的模板</span>                                                        
                                                                </td>
                                                                <td class="empty labelCol">
                                                                </td>
                                                                <td class="empty dataCol">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="dataCol col02" colspan="3">
                                                                    <input type="text" style="width: 445px" value="<%=Postfix%>" name="postFix" id="postFix">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="labelCol">
                                                                ...
                                                                <td class="dataCol col02" colspan="3">
                                                                    <input type="text" style="width: 445px" value="" name="testmobile" id="testmobile"><input
                                                            ...
                                                            <tr>
                                                                <td class="labelCol">
                                                                    <label for="00N9000000DpRrQ">
                                                                        单位通讯</label>
                                                                    <span class="requiredMark">*</span><div class="textCounterOuter">
                                                                        <div class="textCounterMiddle">
                                                                            <div class="textCounter" id="Div1">
                                                                                500 剩余
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <td class="data2Col" colspan="3">
                                                                    <div class="requiredInput">
                                                                        ...
                                                                        <input type="hidden" name="p24_lkid" id="p24_lkid" value="<%=ReceiverIds%>">
                                                                        <input type="hidden" name="p24_lktp" id="p24_lktp" value="">
                                                                        <textarea disabled="disabled" wrap="soft" cols="82" id="p24" maxlength="5000" name="p24" rows="10" title="发送到"
                                                                            type="text"><%=ReceiverNames%></textarea>&nbsp;<a href="javascript:openLookup('/_ui/common/data/invite_UserLookResult.html?lkfm=editPage&amp;lknm=p24&amp;lktp=' + getElementByIdCS('p24_lktp').value,1180,'1','&amp;lksrch=' + escapeUTF(getElementByIdCS('p24').value.substring(0, 80)))"
                                                                                id="p24_lkwgt" onclick="setLastMousePosition(event)" title="发送到 查找（新窗口）"><img src="/s.gif"
                                                                                    alt="接收人 查找（新窗口）" class="lookupIcon" onblur="this.className = 'lookupIcon';"
                                                                                    onfocus="this.className = 'lookupIconOn';" onmouseout="this.className = 'lookupIcon';this.className = 'lookupIcon';"
                                                                                    onmouseover="this.className = 'lookupIconOn';this.className = 'lookupIconOn';"
                                                                                    title="接收人 查找（新窗口）"></a>
                                                                    </div>
                                                                    <a href="javascript:clearLookupFieldValue('p24','p24_lkid')" title="清除已选项">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="data2Col" colspan="3">
                                                                    <div class="requiredInput">
                                                                        ...
                                                                        <input type="hidden" name="p24_lkid" id="p25_lkid" value="<%=ReceiverIds%>">
                                                                        <input type="hidden" name="p25_lktp" id="p25_lktp" value="">
                                                                        <textarea disabled="disabled" wrap="soft" cols="82" id="p25" maxlength="5000" name="p25" rows="10" title="发送到"
                                                                            type="text"><%=ReceiverNames%></textarea>&nbsp;<a href="javascript:openLookup('/alert/address/contractpicker.html?lkfm=editPage&amp;lknm=p25&amp;lktp=' + getElementByIdCS('p25_lktp').value,1180,'1','&amp;lksrch=' + escapeUTF(getElementByIdCS('p25').value.substring(0, 80)))"
                                                                                id="p25_lkwgt" onclick="setLastMousePosition(event)" title="发送到 查找（新窗口）"><img src="/s.gif"
                                                                                    alt="接收人 查找（新窗口）" class="lookupIcon" onblur="this.className = 'lookupIcon';"
                                                                                    onfocus="this.className = 'lookupIconOn';" onmouseout="this.className = 'lookupIcon';this.className = 'lookupIcon';"
                                                                                    onmouseover="this.className = 'lookupIconOn';this.className = 'lookupIconOn';"
                                                                                    title="接收人 查找（新窗口）"></a>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <table width="100%">
                                                                        <tr>
                                                                            <td width="50%"><b>公用组</b>
                                                                                <div style="height: 120px; overflow: auto; border: 1px solid grey;">
                                                                                    <%=GroupHTML%>
                                                                                </div>
                                                                            </td>
                                                                            <td width="50%"><b>个人组</b><div style="height: 120px; overflow: auto; border: 1px solid grey;">
                                                                                <%=PersonGroupHTML%>
                                                                            </div>
                                                                            </td>
                                                                        </tr>
                                                           ...
                                                           <!-- <tr>
                                                                ...
                                                                <td>
                                                                    <textarea wrap="soft" cols="83" id="manualNums" name="manualNums" rows="5" title="发送到"></textarea>
                                                                    <br />
                                                                    一行一个号码，例如<br />
                                                                    13911700000<br />
                                                                    13911800000<br />
    ...
    <script>
        ...
        function getmsgtemplate() {
            ajaxMethodData('oa.sms.owning.template', null, function (data) {
                $('#msgtemplate').html('')
                for (var i = 0; i < data.rows.length; i++) {
                    $('#msgtemplate').append('<option templateid="' + data.rows[i].ValueId + '" value="' + data.rows[i].Description + '">' + data.rows[i].Name + '</option>')
                }
                $('#smsContent').val($('#msgtemplate').val())
                limitText($('#smsContent')[0], 69);
            })
        }
        function msgtemplatechange() {
            $('#smsContent').val($('#msgtemplate').val())
            limitText($('#smsContent')[0], 69);
        }
        function deletetemplate() {
            var id = $('#msgtemplate option:selected').attr('templateid')
            $('#iframe').attr('src', '/alert/delete_ie8.html?id=' + id + '&objTypeCode=20240').show().height(280).css('margin-top', '-140px')
            $('.popup-mask').show()
        }
        function addtemplate() {
            $('.popup-mask').show()
            $('#iframe').show().attr('src', '/alert/msgtemplate_ie8.html').height(620).css('margin-top', '-300px');
        }
        function edittemplate() {
            var id = $('#msgtemplate option:selected').attr('templateid')

            $('.popup-mask').show()
            $('#iframe').show().attr('src', '/alert/msgtemplate_ie8.html?id='+id).height(620).css('margin-top', '-300px');

        }
        function invitepeople(ids, names, lknm) {
            var id = ids.join(',')
            var name = names.join(',')
            $('#' + lknm).val(name)
            $('#' + lknm + '_lktp').val(id)
