<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FlowExecutorViewer.aspx.cs" Inherits="Silverwinder.Shell.flowdesigner.editors.FlowExecutorViewer" %>
...
<head runat="server">
	...
	<script type="text/javascript">
							...
							for (var i = 0; i < nodes.length; i++)
							{
								...
								if (cell != null)
								{
									...
									if (state != 'Init')
									{
										...
										graph.addOverlay(cell, createOverlay(graph.warningImage, 'State: '+state));
									}
								}
							} // for
						}
		...
		function setLayout(layoutXml,statusActivityLayout)
		{
			...
			*/
			//update the status
			update(graph, statusActivityLayout);
		};
