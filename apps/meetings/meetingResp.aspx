<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="meetingResp.aspx.cs" Inherits="WebClient.apps.meetings.meetingResp" %>
...
<head>
    ...
    <title>会议议题: 会议确认 <%=PageTitle%> ~ 高效协同</title>
                    ...
                    <td class="oRight" id="bodyCell">
                        ...
                        <a name="skiplink">
                            <img src="/img/s.gif" height='1' width='1' alt="内容在此开始" class="skiplink skipLinkTargetInner zen-skipLinkTarget" title="内容在此开始" /></a><div class="bPageTitle">
                                <div class="ptBody">
                                    <div class="content">
                                        <img src="/img/s.gif" alt="主页" class="pageTitleIcon" title="主页" /><h1 class="pageType">会议主题<span class="titleSeparatingColon">:</span></h1>
                        ...
                        <form action="/apps/meetings/meetingResp.aspx" id="responseForm" method="post" name="responseForm" onsubmit="if (window.ffInAlert) { return false; }">
                            ...
                            <div class="bPageBlock brandSecondaryBrd bDetailBlock secondaryPalette" id="ep">
                                <div class="pbHeader">
                                    <table border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td class="pbTitle">
                                                <img src="/img/s.gif" alt="" width="1" height="1" class="minWidth" title="" /><h2 class="mainTitle">会议提交信息</h2>
                                            </td>
                                            <td class="pbButton" id="topButtonRow">
                                                ...
                                                <input value=" 接受参加 " class="btn" name="acceptjoin" title="接受参加" type="submit" /> 
                                                <input value=" 拒绝参加 " class="btn" name="decline" title="拒绝参加" type="submit"  /> 
                                ...
                                <div class="pbBody">
                                    ...
                                    <div class="brandTertiaryBrd pbSubheader tertiaryPalette" id="head_1_ep">
                                        <h3>原因<span class="titleSeparatingColon">:</span></h3>
                                    </div>
                                    <div class="pbSubsection">
                                        <table class="detailList" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                 <td class="labelCol">参加</td>
                                                <td class="dataCol col02"><input type="checkbox" name="IsMySelf" id="IsMySelf" value="1" checked="checked" />本参加</td>
                                            </tr>
                                            <tr>
                                                <td class="labelCol">请假</td>
                                                <td class="dataCol col02"><input type="checkbox" name="isLeave" id="isLeave" value="1" />请假 ,请假单：</td>
                                            </tr>
                                            <tr class="last detailRow">
                                               <%--<td class="labelCol">备注</td>--%>
                                               <td colspan='4'  class="dataCol col02">
