<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="meetingedit.aspx.cs" Inherits="WebClient.apps.meetings.meetingedit" %>
...
<head>
    ...
    <script>        window.sfdcPage = new EditPage(null);</script>
                ...
                <tr>
                    ...
                    <td id="bodyCell" class="oRight"><a name="skiplink">
                        ...
                        <div class="bPageTitle">
                            <div class="ptBody">
                                <div class="content">
                                    <img title="会议" class="pageTitleIcon" alt="会议" src="/s.gif"><h1 class="pageType">会议<span class="titleSeparatingColon">:</span></h1>
                        ...
                        <script src="/apps/CommandProcessor.ashx?cmd=picklist&e=20015&amp;h=%2BoZDvGnbcaPTq%2BeM%2FeiE6ka%2BQxvs%2BYMIg0fvSWH0Ibo%3D&amp;v=1412752376000&amp;layout=00h9000000RbNyf&amp;mo=EDITLOAD&amp;esc=HTML&amp;l=zh_CN&amp;pr=1.25&amp;t=0"></script>
                       <div class="apexp">
                        <form action="/00V/e" id="editPage" method="post" name="editPage" onsubmit="if (!validateForm()) {return false;} if (window.ffInAlert) { return false; }if (window.sfdcPage && window.sfdcPage.disableSaveButtons) { return window.sfdcPage.disableSaveButtons(); }">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td id="bottomButtonRow" class="pbButtonb">
                                                        <input type="submit" id="j_id150:save" name="save" value="保存" onclick="return validateForm();" title="保存" class="btn primary">
                                                        <input type="submit" title="取消" tabindex="80" name="cancel" class="btn" value=" 取消 " />
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
