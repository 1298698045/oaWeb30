<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="easysrchlst.aspx.cs" Inherits="WebClient.apps.easysrchlst" %>
                        ...
                        <a name="skiplink">
                            <img src="/s.gif" height='1' width='1' alt="内容在此开始" class="skiplink skipLinkTargetInner zen-skipLinkTarget"
                                title="内容在此开始" /></a><div class="bPageTitle">
                                    <div class="ptBody">
                                        <div class="content"><h5 class="pageDescription1"><%=PageTitle%></h5><!--
