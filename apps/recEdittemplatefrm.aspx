<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="recEdittemplatefrm.aspx.cs" Inherits="WebClient.apps.recEdittemplatefrm" %>
...
<head>
    ...
    <title>编辑:<%=PageTitle%>  - Developer Edition</title>
                    ...
                    <td class="oRight" id="bodyCell">
                        ...
                        <a name="skiplink">
                            <img src="/img/s.gif" height='1' width='1' alt="内容在此开始" class="skiplink skipLinkTargetInner zen-skipLinkTarget" title="内容在此开始" /></a><div class="bPageTitle">
                                <div class="ptBody">
                                    <div class="content">
                                        <img src="/img/s.gif" alt="主页" class="pageTitleIcon" title="主页" /><h1 class="pageType"><%=PageTitle%>编辑<span class="titleSeparatingColon">:</span></h1>
                                        <h2 class="pageDescription"></h2>
                                        <div class="blank">&nbsp;</div>
                                    </div>
                                    <div class="links">
                                        <a class="configLinks" href="javascript:openPopupFocusEscapePounds(%27p%27, %27Help%27, 1024, 768, %27width=1024,height=768,resizable=yes,toolbar=yes,status=yes,scrollbars=yes,menubar=yes,directories=no,location=yes,dependant=no%27, false, false);"
                                            title="此页面的帮助 （新窗口）">打印表单</a>
                                    </div>
                                </div>
                        ...
                        <form action="/<%=EntityCode%>/e" id="editPage" method="post" name="editPage" onsubmit="if (!validateAndSave()) {return false;} if (window.ffInAlert) { return false; }if (window.sfdcPage && window.sfdcPage.disableSaveButtons) { return window.sfdcPage.disableSaveButtons(); }">
                            <cc1:RegisterParamsHiddenFieldsControl runat="server" ID="RegisterParamsHiddenFieldsControl1" />
                            <div class="bPageBlock brandSecondaryBrd bEditBlock secondaryPalette" style="background-color: #fff;" id="ep">
                                <%=EditFormBody%>
                                <div class="pbBottomButtons" style="margin-top: 10px;">
                                    <table border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td class="pbTitle">
                                                <img src="/img/s.gif" alt="" class="minWidth" title="" width="1" height="1">&nbsp;</td>
                                            <td class="pbButtonb" id="bottomButtonRow">
                                                <input value=" 保存 " class="btn" name="save" tabindex="31" title="保存" type="submit" style="height: 25px;" />
                                                <input value=" 保存并新建 " class="btn" name="save_new" tabindex="32" title="保存并新建" type="submit" style="height: 25px;" />
                                                <input value=" 取消 " class="btn" name="cancel" tabindex="33" title="取消" type="submit" onclick="cancelAciton()" style="height: 25px;" />
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                        ...
                        <script type="text/javascript">
                            ...
                            function validateAndSave() {
                                ...
                                isValidated = customValidateForm();
