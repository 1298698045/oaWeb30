...
<head>
    ...
    <style>
        ...
        .calendar3 .calendarUserTimezoneOffset{
            width:12.5%;
        }
        .calendar3 .rili_calender_strong{
            padding-left:50px;
        }
        .slds-brand-band-zhou .calendarDayHeaders{
            padding:0;
            width:87.5%;
            left:12.5% !important;
            margin-left:-1px;
        ...
        .calendar2 .calendarDayHeaders{
            padding-right:0;
        }
        .calendar2 .calendarRow{
            border-right:0;
        }
        .calendar2 .calendarDayHeaders{
            border-right:0;
        ...
        .calendar3 .calendarRow{
            overflow-y:auto;
        }
        .meetingroom-message-hover1{
            z-index:1001;
        }
    </style>
</head>
<body onunload="if(this.bodyOnUnload)bodyOnUnload();" onbeforeunload="if(this.bodyOnBeforeUnload){var s=bodyOnBeforeUnload();if(s)return s;}" onload="if(this.bodyOnLoad)bodyOnLoad();" class="hasMotif campaignTab   ext-gecko ext-gecko3 sfdcBody brandQuaternaryBgr" onfocus="if(this.bodyOnFocus)bodyOnFocus();">
    <div id="contentWrapper" style="vertical-align: middle">
        ...
        <script src="/template/js/meetingroom.js?a=1"></script>
