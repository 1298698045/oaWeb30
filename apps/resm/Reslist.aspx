<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reslist.aspx.cs" Inherits="WebClient.apps.resm.Reslist" %>
...
<head>
    ...
    <title>资源管理 ~  行政管理 - Developer Edition</title>
...
<body onunload="if(this.bodyOnUnload)bodyOnUnload();" onbeforeunload="if(this.bodyOnBeforeUnload){var s=bodyOnBeforeUnload();if(s)return s;}" onload="if(this.bodyOnLoad)bodyOnLoad();" class="hasMotif contactTab  overviewPage sfdcBody brandQuaternaryBgr   ext-gecko ext-gecko3" onfocus="if(this.bodyOnFocus)bodyOnFocus();">
                    ...
                    <td class="oRight" id="bodyCell">
                        <div class="miss-header">
                            ...
                            <div class="header-left-title">
                                <p class="header-left-title-name">资源管理</p>
                                <p class="header-left-title-listname selectinput"><span>资源</span><img src="/img/cal/20.png" alt="" /></p>
                            ...
                            <div class="header-right-buttonbtn">
                                <div class="buttonbtn-group">
                                    <div class="buttonbtn"><a href="/023/e?retURL=%2f023%2f/o">新建</a></div>
                                </div>
                            </div>
                            <div class="header-right-buttonbtn">
    ...
    <script>
        function formatOper(val, row, index, entityType) {
            ...
            return '<a style=\"color:#015ba7;font-size:13px;\" href="e?id=' + rowId + '&retURL=/023/o">修改</a>&nbsp;|&nbsp;<a style=\"color:#015ba7;font-size:13px;\" onclick=deleterow("' + rowId + '")  href=\"#\">删除</a>'
                   + '&nbsp;|&nbsp<a style=\"color:#015ba7;font-size:13px;\" href="/' + entityType + '/detail?objectTypeCode=' + webContext.objectTypeCode + '&id=' + rowId + '">查看</a>&nbsp;';
        }
        function deleterow(id) {
            $('#iframe').attr('src', '/alert/delete_ie8.html?id=' + id + '&objTypeCode=20034').show().height(280).css('margin-top', '-140px')
            $('.popup-mask').show()
        }
