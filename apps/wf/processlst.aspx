<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="processlst.aspx.cs" Inherits="WebClient.apps.wf.processlst" %>
...
<html class="">
<head>
    <title>流程管理 ~ .com - Developer Edition</title>
  ...
  <cc1:StyleAdapter runat="server" id="StyleAdapter" />
    ...
    <link class="user" href="/EXT/ext-3.3.3/resources/css/ext-all-notheme.css" rel="stylesheet"
        type="text/css" />
    <link class="user" href="/sCSS/31/sprites/Theme3/zh/base/ExtCSS-SFDC.css" rel="stylesheet"
        type="text/css" />
                    ...
                    <td class="noSidebarCell">
                            ...
                            <img src="/s.gif" height='1' width='1' alt="内容在此开始" class="skiplink skipLinkTargetInner zen-skipLinkTarget"
                                ...
                                <span id="thePage:j_id0"></span><div class="bPageTitle">
                                        <div class="ptBody secondaryPalette brandSecondaryBrd">
                                            <div class="content">
                                                <img src="/s.gif" class="pageTitleIcon" title="流程" alt="流程" /><h1 class="pageType noSecondHeader">
                                                    流程管理</h1>
                                                <div class="blank">
                                                </div>
                                            </div>
                        ...
                        <div class="addNewButtons">
                            <input class="btn" onclick="newInfo()"
                                title="新建流程..." type="button" value="新建流程..." /><!--
                        ...
                        <script type="text/javascript">
                          ...
                          <input type="hidden" name="type" id="type" value="121" />
                        <input type="hidden" name="t" id="t" value="121" />
                            ...
                            <div class="sidebar" id="sidebar">
                                <script type="text/javascript" >
                                    ...
                                    Ext.onReady(function () {
                                        var type = document.getElementById("type").value;
                                        var tab = document.getElementById("t").value;
                                        var newItemFolderUrl = '/00l/e?t=' + tab + '&oType=121&retURL=%2F' + tab + '%2Fo';
                                        //if (type == "100202") {
                                        ...
                                        new Sfdc.analytics.home.FolderTree({
                                            ...
                                            */
                                            dataUrl: "/_ui/process/FolderTreeServlet?type=121",
