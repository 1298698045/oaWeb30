...
{
    public partial class ApplyInstFromObject : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request["objectName"] != null)
                _objectName = Request["objectName"];
           // if (Request["parentInstanceId"] != null)
             //   _objectId = Request["parentInstanceId"];
            ...
            //ProcessInstance procInstance = WfInstanceManager.GetProcessInstance(new Guid(_objectId));           
            //if (procInstance != null)
            //{
            //    entityType = procInstance.ProcessScheme.EntityType.ToString();
            //    this.ObjectName = procInstance.Name;
            //}
        ...
        public void CreateInstance()
        {
            ...
            Guid processInstanceId = new Guid(this.ObjectId);
            ...
            //设置父实例
           // Guid parentInstanceId = new Guid(_objectId);
        ...
        void CreateEntity(Guid processInstanceId, Guid processSchemeId, string processName)
        {
            ...
            try
            {
                ...
                Entity parentEntity = EntityManager.GetEntity(caller, temp, new Guid(_objectId));
        ...
        public string ObjectId { set { _objectId = value; } get { return _objectId; } }
        public string ObjectName { set { _objectName = value; } get { return _objectName; } }
    }
}