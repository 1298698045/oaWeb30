    ...
    <script type="text/javascript">
        ...
        function fillTransations(data) {
           ...
           // debugger;
            ...
            var disabled = "";
            var diplayTransitionCount = 0;
            var hasCondition = data.hasCondition;
            if (matchCondition) {
            ...
            for (var i = 0; i < data.rows.length; i++) {
                ...
                {
                    //有条件，但是没有一条匹配上
                    if (item.MatchCondition == false)
                        continue;
                }
                diplayTransitionCount++;
                if (item.Selected) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="dataCol col02">
                                                                    <input type="checkbox" id="noticeMessage" name="noticeMessage" checked="checked" />系统消息
                                                                        <input type="checkbox" id="noticeSms" name="noticeSms"  />手机短信
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
