<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplyInstance.aspx.cs"
    Inherits="WebClient.apps.wf.ApplyInstance" %>
                ...
                <tbody>
                    <tr>
                        ...
                        <td id="bodyCell" class="oRight">
                            ...
                            <a name="skiplink">
                                <img width="1" height="1" title="内容在此开始" class="skiplink skipLinkTargetInner zen-skipLinkTarget"
                                    alt="内容在此开始" src="/s.gif"></a><div class="bPageTitle">
                                        <div class="ptBody">
                                            <div class="content">
                                                <img title="联系人" class="pageTitleIcon" alt="联系人" src="/s.gif" /><h1 class="pageType noSecondHeader">
                                                    事务管理：创建事务</h1>
                                                <div class="blank">
                                                    &nbsp;</div>
                                            </div>
                            ...
                            name="stageForm" method="POST" id="stageForm"  enctype="multipart/form-data" action="ApplyInstance.aspx" >
                            ...
                            <div class="bWizardBlock tertiaryPalette">
                                ...
                                <div class="pbBody">
                                    <div class="pbWizardHeader">
                                        <div style="white-space: nowrap" class="pbTopButtons" style="float:none;text-align:center;">
                                            <!--<input type="submit" title="上一页" name="goPrevious" class="btn" value=" 上一页 ">&nbsp;-->
                                            <input type="submit" title="下一页" name="goNext" class="btn" style="height:25px;" value=" 下一步 " /><input
                                                type="submit" title="取消" name="cancel" class="btnCancel" value=" 取消 " style="height:25px;"/>
                                        </div>
                                    </div>
                                    <div class="pbJumpTo">
                                    </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="data2Col">
                                                                <div class="requiredInput">
                                                                    ...
                                                                    <input type="text" value="" name="instanceName" id="instanceName" style="width: 300px;height:20px;" />
                                                                </div>
                                                            </td>
                                                            <td class="labelCol requiredInput">
                                    ...
                                    <h3>
                                        附件<span class="titleSeparatingColon">:</span></h3>
                                </div>
                                          <div class="pbSubsection">
                                                 <table cellspacing="0" cellpadding="0" border="0" class="detailList">
                                                    <tbody><tr>
                                                        ...
                                                        <tr>
                                                            <td class="labelCol requiredInput">
                                                                <label for="macmw_campaignName">
                                                                    <span class="requiredMark">*</span>选择附件：</label>
                                                            </td>
                                                            <td>
                                            ...
                                            <span class="bFilter">
                                                <label style="text-align: left; font-weight: bold; padding-right: .69em;" for="fcf_templateSelector">
                                                    <span class="requiredMark">*</span>流程分类</label><span class="fBody"><select onchange="refreshProcessPage(this.value)"
                                                        ...
                                                        <!--<option selected="selected" value="00D90000000yI4o">
                                                            未归档公用电子邮件模板</option>
                                                        -->
                                                        <%=WFCategory%>
                                    ...
                                    <div class="pbWizardFooter">
                                        <div class="pbBottomButtons" style=" float:none;text-align:center;">
                                            <!--<input type="submit" title="上一页" name="goPrevious" class="btn" value=" 上一页 ">&nbsp;-->
                                            <input type="submit" title="下一页" name="goNext" class="btn" value=" 下一步 " style="height:25px;"><input type="submit"
                                                title="取消" name="cancel" class="btnCancel" value=" 取消 " style="height:25px;"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
