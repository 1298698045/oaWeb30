...
<head>
    ...
    <style type="text/css">
        ...
        #gridContainerdiv .datagrid-wrap.panel-body.panel-body-noheader {
            border-left:0;
        }
    </style>
    <style>
...
<body onunload="if(this.bodyOnUnload)bodyOnUnload();" onbeforeunload="if(this.bodyOnBeforeUnload){var s=bodyOnBeforeUnload();if(s)return s;}" onload="if(this.bodyOnLoad)bodyOnLoad();" class="hasMotif contactTab   ext-gecko ext-gecko3 sfdcBody brandQuaternaryBgr" onfocus="if(this.bodyOnFocus)bodyOnFocus();">
                        ...
                        <div id="bodyWrapper">
                            ...
                            <div class="miss-header">
                                ...
                                <div class="header-left-title">
                                    <p class="header-left-title-name">签名管理</p>
                                    <p class="header-left-title-listname selectinput"><span>我的签名管理</span><img src="/img/cal/20.png" alt="" /></p>
                                ...
                                <div class="header-right-buttonbtn">
                                    <div class="buttonbtn-group">
                                        <div class="buttonbtn"><a id="newbtn">新建</a></div>
                                    </div>
                                </div>
                                <div class="header-right-buttonbtn">
                                    <div class="buttonbtn buttonbtnsousuo">
                                        <input type="text" placeholder="搜索此列表..." id="srchText" name="srchText" class="searchtext" onchange="getdata()" />
                                    </div>
                            ...
                            <div class="table-body">
                                <div class="objectManagerLeftNav" style="padding-top: 0; height: 100%; padding-bottom: 0;">
                                    <div id="treePanel" class="easyui-panel" title="组织结构" style="padding: 5px; width: 240px; min-height: 0!important; height: calc(100% - 49px)!important; min-height: 200px;">
                                        <ul class="easyui-tree" id="leftTree" style="display: block; height: 100%; min-height: 300px;">
                                            <li></li>
                                        </ul>
                                    </div>
                                    <div id="gridContainerdiv" style="float:none;">
                                ...
                                <script type="text/javascript">
                                    ...
                                    $(document).ready(function () {
                                        ...
                                        $("#treePanel").height(screenHeight - 111 - 100 - 50);
                                    });
                                    function treeItemClick(node) {
                                        ...
                                        var extSrch = "BusinessUnitId\tin\t" + ids;
                                        getdata(extSrch);
                                    }
                                ...
                                <script>
                                    function deleteSigna(id) {
                                        $('#iframe').attr('src', '/alert/delete_ie8.html?id=' + id + '&objTypeCode=deleteSigna').show().height(280).css('margin-top', '-150px')
                                        $('.popup-mask').show()
                                    }
                                    $('#gridContainerdiv').height($(window).height() - 203)
                                    $('#gridContainer').height($(window).height() - 203)
                                    getdata()
                                    function getdata(filterQuery) {
                                        ...
                                        $('#gridContainer').datagrid({
                                            columns: [[
                                                {
                                                    ...
                                                    formatter: function formatter(value, row, index) {
                                                        ...
                                                        var action = '<a style="color:#015ba7;font-size:13px;" onclick="editSigna(' + "'" + rowId + "'," + "'" + FullName +"'"+ ')">编辑签名</a>'
                                                        action += '&nbsp&nbsp|&nbsp&nbsp<a style="color:#015ba7;font-size:13px;" onclick="deleteSigna(' + "'" + rowId + "'" + ')">删除</a>'
                                                        return action;
                                                    }
                                                },
                                                {
                                            ...
                                            pagination: true,
                                            rownumbers: true,
                                            url: '/apps/CommandProcessor.ashx?c=1&cmd=process.signature.search',
                                            striped: false,
                                            queryParams: {
                                    ...
                                    function formatOper(val, row, index, entityType) {
                                        ...
                                        var action = "<a style=\"color:#015ba7;font-size:13px;\" onclick=\"showEditDialog('" + rowId + "','" + entityType + "')\">修改</a>";
                                        //&nbsp;|&nbsp;<a style=\"color:#015ba7;font-size:13px;\" href=\"#\" onclick=\"deleteConfirm('" + rowId + "','" + entityType + "')\">删除</a>";
                                        //&nbsp;|&nbsp;<a style=\"color:#015ba7;font-size:13px;\" onclick=\"printContract('" + rowId + "','" + entityType + "')\">打印</a>
                                        action += "&nbsp;|&nbsp;<a style=\"color:#015ba7;font-size:13px;\" href=\"#\" onclick=\"deleteConfirm('" + rowId + "','" + webContext.objectTypeCode + "')\">删除</a>";
                                        return action;
                                    }
                                    function editSigna(id,name) {
                                        $('#iframe').attr('src', '/alert/workflow/editsign.html?id=' + id + '&objTypeCode=deleteSigna'+'&Name='+name).show().height(620).css('margin-top', '-320px')
                                        $('.popup-mask').show()
                                    }
                                    </script>
                            </div>
    ...
    <script>
        ...
        $('#newbtn').click(function () {
            $('#iframe').show().attr('src', '/alert/workflow/signatureUpload.html')
            $('.popup-mask').show()
        })
    </script>
