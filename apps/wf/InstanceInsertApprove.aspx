<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InstanceInsertApprove.aspx.cs" Inherits="WebClient.apps.wf.InstanceInsertApprove" %>
        ...
        <div >
                ...
                <table class="detailList" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td class="labelCol requiredInput">
                            <label for="cpn1">
                                <span class="requiredMark">*</span><b>节点名称：</b></label>
                        </td>
                    ...
                    <tr>
                        <td class="labelCol requiredInput">
                            <label for="cpn1">
                                <span class="requiredMark">*</span><b>需要加签节点：</b></label>
                        </td>
                        <td class="dataCol col02">
                    ...
                    <tr>
                        <td class="labelCol requiredInput">
                            <label for="cpn1">
                                <span class="requiredMark">*</span><b>加签类型：</b></label>
                        </td>
                        <td class="dataCol col02">
                            <div class="layui-form">
                                <div class="layui-input-block">
            ...
            <table cellspacing="0" cellpadding="0" border="0" style="text-align:center;">
                <tbody>
                    <tr>
                        <td>
                            <input type="button" name="save" title="确定" class="primary btn" value=" 确定 " style="height: 25px;"  onclick="insertApprove(false);" />
    ...
    <script src="/js/CommonUtils.js"></script>
        <script type="text/javascript">
            ...
            function insertApprove()
            {
                ...
                ajaxMethodPostData("process.instance.insertapprove", d, function () { closeDialog(false); });
            }
        </script>
        <script  type="text/javascript">
            var form
