...
<head>
    ...
    <title>流程事务：<%=InstanceName %>     ~ .com - Professional Edition</title>
    ...
    position: absolute;*/
                            ...
                            <div class="helpElement">
                                <span class="helpLinkElement"><!--<a title="编辑布局" target="_top" name="editLayout" href="/layouteditor/docLayoutEditor.aspx?setupid=CustomObjects&id=<%=FormLayoutId%>&amp;retURL=%2F5009000000lRqdV">
                                    ...
                                    <!--<a title="正文 （新窗口）" style="text-decoration:none; vertical-align:middle;"
                                        name="uploadView" target="_blank" href="/apps/files/DocEditor.aspx?Id=<%=InstanceId%>&fullscreen=0&EditType=<%=MainDocEditMode%>&filesource=2&OrganizationId=<%=OrganizationId%>"><img width="20" height="20" title="正文内容 （新窗口）" alt="正文内容 （新窗口）" class="uploadArrow" src="/img/fujian.gif" align="absmiddle"/><span class="helpLink">正文</span></a>-->
                                    <%if (this.EditMode)
                                      {%>                                
                                    <a title="上传附件 （新窗口）" style="text-decoration:none; vertical-align:middle;"
                                        name="uploadView" href="#" onclick="setLastMousePosition(event);openPopup('/attach/ActivityAttach.aspx?relatedListId=InstanceAttachmentList&type=<%=EntityObjectType%>&pid=<%=InstanceId%>', 'doc', 450, 450, 'width=450,height=450,scrollbars=yes,toolbar=no,status=no,directories=no,menubar=no,resizable=1', false);"><img width="20" height="20" title="上传附件 （新窗口）" alt="上传附件 （新窗口）" class="uploadArrow" src="/img/fujian.gif" align="absmiddle"/>上传附件</a>
                                    <a title="关联流程 （新窗口）" style="text-decoration:none; vertical-align:middle;"
                                        name="uploadView" href="#" onclick="setLastMousePosition(event);openRelateInstance()", 'doc', 680, 500, 'width=680,height=500,scrollbars=yes,toolbar=no,status=no,directories=no,menubar=no,resizable=1', false);"><img width="16" height="16" title="关联流程 （新窗口）" alt="关联流程 （新窗口）" class="uploadArrow" src="/img/images/guanlian.png" align="absmiddle"/>关联流程</a>
                                    <%} %>
                                    <a title="可打印视图 （新窗口）" style="text-decoration:none; vertical-align:middle;"
                                        name="printView" href="javascript:printWin('/apps/wf/WFFormPrint.aspx?InstanceId=<%=InstanceId%>')"><img title="正文 （新窗口）" class="printerIcon" alt="正文 （新窗口）" src="/s.gif"  align="absmiddle"><span class="helpLink">打印</span></a>
                                    
                                    </span></div>
                                    <script type="text/javascript">
                                        //$('#relateInstance').click(function(){
                                        //    opencenterwindow('/alert/wf/relateInstance.html', '', 1000, 600);
                                        //})
                                        function openRelateInstance()
                                        {
                                            opencenterwindow('/alert/wf/relateInstance.html?InstanceId=<%=InstanceId%>', '', 1000, 600);
                                        }
                                        //openPopup('/apps/wf/addRelatedInsts.aspx?instanceid=<%=InstanceId%>&retURL=%2fapps%2fwf%2fInstanceDetail.aspx%3ft%3d122%26id%3d73a87b11-5325-4e18-8f32-49eb5210f283&pid=<%=InstanceId%>&type=<%=EntityObjectType%>
                                                                 </script>
                                                        ...
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                ...
                                                                <td style="width:20%">
                                                                    ...
                                                                    <iframe width="100%" height="450" frameborder="0"   id="ifrmAttaches" src="/apps/wf/InstanceAttachList.aspx?InstanceId=<%=InstanceId%>&InstanceState=<%=InstanceState%>&ProcessId=<%=ProcessId%>&StepId=<%=StepId%>&right=<%=AttachRight%>"></iframe>
                                                ...
                                                <table cellspacing="0" cellpadding="0" border="0">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td id="bottom2ButtonRow" class="pbButtonb">
                                                                <%if (EditMode)
                                                                 { %> 
                                                                 <%if (!IsFirstActivity)
                                                                 {%>
                        ...
                        <script type="text/javascript">
                                    ...
                                    function approvePass()
                                    {
                                        ...
                                        showDialog(url1, "ApproveReject", "审批通过流转", 870, 550);
                                    }
