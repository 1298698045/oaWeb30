<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CloneInstance.aspx.cs" Inherits="WebClient.apps.wf.CloneInstance" %>
...
<head>
    ...
    <title>流程事务: 克隆创建事务 ~ .com - Professional Edition</title>
                ...
                <tbody>
                    <tr>
                        ...
                        <td id="bodyCell" class="oRight">
                            ...
                            <a name="skiplink">
                                <img width="1" height="1" title="内容在此开始" class="skiplink skipLinkTargetInner zen-skipLinkTarget"
                                    alt="内容在此开始" src="/s.gif"></a><div class="bPageTitle">
                                        <div class="ptBody">
                                            <div class="content">
                                                <img title="创建子事务" class="pageTitleIcon" alt="创建子事务" src="/s.gif" /><h1 class="pageType noSecondHeader">
                                                    事务管理：创建子事务</h1>
                                                <div class="blank">
                                                    &nbsp;</div>
                                            </div>
                            ...
                            name="stageForm" method="POST" id="stageForm" action="CloneInstance.aspx">
                                                        ...
                                                        <tr>
                                                            <td class="labelCol requiredInput">
                                                                <label for="macmw_campaignName">
                                                                    <span class="requiredMark">*</span>父实例：</label>
                                                            </td>
                                                            <td colspan="3">
                                                                 <input id="parentInstanceId" name="parentInstanceId" value="<%=ParentInstanceId%>" type="hidden" />
                                                              <b style="font-size:14px;">  <%=ParentInstanceName%></b>
                                                            </td>
                                                        </tr>
                                                         <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="data2Col">
                                                                <div class="requiredInput">
                                                                    ...
                                                                    <input type="text" name="instanceName" id="instanceName"  value="<%=ParentInstanceName%>" style="width: 400px;height:20px;" />
                                                                </div>
                                                            </td>
                                                            <td class="labelCol requiredInput">
