<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyApplyList.aspx.cs" Inherits="WebClient.apps.wf.MyApplyList" %>
...
<head>
    ...
    <title>流程管理：<%=SubTitle%> ~ .com - Developer Edition</title>
    ...
    <link href="/sCSS/34.0/sprites/1438195776000/Theme3/zh/<%=Supermore.WebContext.SkinName%>/ExtCSS-SFDC.css" rel="stylesheet"
        type="text/css" />
    <link href="/sCSS/34.0/sprites/1438195776000/Theme3/zh/<%=Supermore.WebContext.SkinName%>/CampaignManageMembers.css"
...
<body onload="if(this.bodyOnLoad)bodyOnLoad();" onunload="if(this.bodyOnUnload)bodyOnUnload();"
    class="hasMotif Custom18Tab  CampaignManageMembersAddTab   ext-gecko ext-gecko3 sfdcBody brandQuaternaryBgr"
                ...
                <tbody>
                    <tr>
                        ...
                        <td id="bodyCell" class="oRight">
                            ...
                            <div class="bPageTitle" style="display:block;">
                                <div class="ptBody">
                                    <div class="content">
                            ...
                            <%=SubTabContent%>
                            <br />                           
                            <table id="toolsContent" class="toolsContent" style="display:none">
                                <tbody>
                                    <tr>
                                        <td>
                                            <div>
                                                <div class="bSubBlock brandSecondaryBrd secondaryPalette">
                                                    ...
                                                    <div class="lbBody">
                                                        <ul>
                                                            <li><a href="/0Yd/filter">
                                                                效能曝光报表</a></li><li><a href="#">
                                                                    月办理事务报表</a></li><!--<li><a href="/00O?rt=9&amp;retURL=%2F701%2Fo&amp;t=title12&amp;open=closedwon&amp;break0=CAMPAIGN_NAME&amp;c=FN&amp;c=AN&amp;c=ON&amp;c=SN&amp;c=FQ&amp;c=CD&amp;c=TY&amp;c=CAMPAIGN_NAME&amp;s=AM&amp;a=AG&amp;details=yes&amp;format=t">
                                                                        市场活动收入报表</a></li>--></ul>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div>
                                                <div class="bSubBlock brandSecondaryBrd secondaryPalette">
                                                    ...
                                                    <div class="lbBody">
                                                        <ul>
                                                            <li><a href="/130/filter">
                                                                我的审批意见库</a></li><!--<li><a href="/00O?rt=8&amp;retURL=%2F701%2Fo&amp;format=x&amp;break0=CTY&amp;break0a=CAN&amp;break1=MEMBER_STATUS&amp;scope=user&amp;c=CAN&amp;c=MEMBER_STATUS&amp;details=yes">
                            ...
                            <script type="text/javascript">
                                CampaignManageMembersTab(0,true);
