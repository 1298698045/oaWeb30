<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addGroupto.aspx.cs" Inherits="WebClient.apps.addGroupto" %>
...
<head>
    <title><%=PageTitle%>选择适用于：<%=AddToTitle%></title>
                ...
                <tr>
                    ...
                    <td id="bodyCell" class="oRight"><a name="skiplink">
                        <img width="1" height="1" title="内容在此开始" class="skiplink skipLinkTargetInner zen-skipLinkTarget" alt="内容在此开始" src="/s.gif"></a><div class="bPageTitle">
                            <div class="ptBody">
                                <div class="content">
                                    <img title="" class="pageTitleIcon" alt="" src="/s.gif"><h1 class="pageType">添加到<span class="titleSeparatingColon">:</span></h1>
                        ...
                        <form onsubmit="javascript:saveAllSelected([ document.editPage.duel_select_0, document.editPage.duel_select_1 ], [ document.editPage.duel0, document.editPage.duel1 ], ',', '\\', '--无--');if (window.ffInAlert) { return false; }" name="editPage" method="post" id="editPage" action="/meeting/mem/addFromGroup">
                            ...
                            <div id="ep" class="bPageBlock brandSecondaryBrd bEditBlock bLayoutBlock secondaryPalette">
                                ...
                                <div class="pbBody">
                                                ...
                                                <tr class="last detailRow">   
                                                    <td colspan="4">
                                                        <div id="duel" class="duelingListBox">
                                                            ...
                                                            <div>
                                                                <label for="sharing_search">搜索：</label>&nbsp;<select title="小组类型" onchange="duel_select_0Var.filter()" name="sharing_search" id="sharing_search">
                                                                    <option selected="selected" value="P">个人小组</option>
                                                     ...
                                                     <td align="left" style="width:30%">
                                                        <span style="color:red;font-weight:bold;">排除成员：</span><br />
                                              ...
                                              function getGroupRoleUser0(val) {
                                                  ...
                                                  ajaxMethodData("group.user.getlist", d, function (data) {
                                                      ...
                                                      for (var l = 0; l < data.listData.length; l++) {
                                                          ...
                                                          html1 += "<div><input type='checkbox' value=\"" + row.id + "\" name=\"groupUser\" />" + row.name + "</div>";
                                                      }
                                    ...
                                    <div class="pbSubsection" style="list-style-type:none;">
                                        <table class="detailList" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td  class="dataCol col02">
                                                    <div class="requiredInput">
                                                        <div class="requiredBlock"></div>
                                                        <input type="text" size="70" name="p6" maxlength="100" id="p6" value="【会议通知】"></div>
                                                </td>
                                            ...
                                            <tr class="last detailRow">
                                                <td></td>
                                                <td colspan='3'>
                                                    <input id="sendSms" name="sendSms" type="checkbox" value="1" checked="checked" /><label
                            ...
                            <script type="text/javascript">
                                var duel_select_0Var = new SelectFilterElement("sharing_search", "P", "duel_select_0", "", "duel_select_1", 100, true, null);
