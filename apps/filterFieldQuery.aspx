<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="filterFieldQuery.aspx.cs" Inherits="WebClient.apps.filterFieldQuery" %>
...
<head>
    ...
    <title><%=PageTitle%>：<%=SubTitle%> - Developer Edition</title>
...
<body onunload="if(this.bodyOnUnload)bodyOnUnload();" onbeforeunload="if(this.bodyOnBeforeUnload){var s=bodyOnBeforeUnload();if(s)return s;}" onload="if(this.bodyOnLoad)bodyOnLoad();" class="hasMotif <%=TabCss%>  overviewPage  ext-gecko ext-gecko3 sfdcBody brandQuaternaryBgr" onfocus="if(this.bodyOnFocus)bodyOnFocus();">
                    ...
                    <td class="oRight" id="bodyCell">
                        ...
                        <a name="skiplink">
                            <img src="/s.gif" height='1' width='1' alt="内容在此开始" class="skiplink skipLinkTargetInner zen-skipLinkTarget" title="内容在此开始" /></a><div class="bPageTitle">
                                <div class="ptBody">
                                    <div class="content">
                                        <img src="/s.gif" alt="<%=SubTitle%> " class="pageTitleIcon" title="" /><h1 class="noSecondHeader pageType"><%=PageTitle%>：<%=SubTitle%> </h1>
                                        <div class="blank">&nbsp;</div>
                                    </div>
                        ...
                        <script src="/apps/CommandProcessor.ashx?cmd=picklist&e=8&amp;h=%2BoZDvGnbcaPTq%2BeM%2FeiE6ka%2BQxvs%2BYMIg0fvSWH0Ibo%3D&amp;v=1412752376000&amp;layout=00h9000000RbNyf&amp;mo=EDITLOAD&amp;esc=HTML&amp;l=zh_CN&amp;pr=1.25&amp;t=0"></script>
                        <form action="" id="dispatch" method="post" name="dispatch"  onsubmit="if (window.ffInAlert) { return false; }">
                                ...
                                <div class="bPageBlock brandSecondaryBrd">
                                    <div class="pbHeader" id="lineItemView_searchHeader">
                                        <table border="0" cellpadding="0" cellspacing="0" summary="用户">
                                          <!--  <tr>
                                                <td class="pbTitle">
                                                    <img src="/s.gif" alt="" width="12" height="1" class="minWidth" style="margin-right: 0.25em;" title="" /><img src="/s.gif" alt="" class="relatedListIcon" title="" /><h3><span class="searchFirstCell">查找</span></h3>
                                                </td>
                            ...
                            <div class="individualPalette listViewportWrapper" id="lineItemView_wrapper">
                                <div class="listViewport opportunityBlock" id="lineItemView_listViewport">
                                    <form action="" id="lineItemView_actionForm" method="POST" name="lineItemView_actionForm" onsubmit="return ListViewport.instances['lineItemView'].verify('请至少选择一行')">
                                        <input type="hidden" id="lineItemView_pageState" name="lineItemView_pageState" value="" /><input type="hidden" id="lineItemView_rolodexState" name="lineItemView_rolodexState" value="" />
                                       <div class="topNav primaryPalette" id="lineItemView_topNav">
