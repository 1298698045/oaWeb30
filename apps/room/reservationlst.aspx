...
<head>
    ...
    <title>会议室 ：我的预约 ~  - Developer Edition</title>
...
<body onunload="if(this.bodyOnUnload)bodyOnUnload();" onbeforeunload="if(this.bodyOnBeforeUnload){var s=bodyOnBeforeUnload();if(s)return s;}" onload="if(this.bodyOnLoad)bodyOnLoad();" class="hasMotif contactTab  overviewPage sfdcBody brandQuaternaryBgr   ext-gecko ext-gecko3" onfocus="if(this.bodyOnFocus)bodyOnFocus();">
                    ...
                    <td class="oRight" id="bodyCell">
                       <div class="miss-header">
                        ...
                        <div class="header-left-title">
                            <p class="header-left-title-name">会议室</p>
                            <p class="header-left-title-listname selectinput"><span>我的预约</span><img src="/img/cal/20.png" alt="" /></p>
                        ...
                        <div class="header-right-buttonbtn">
                            ...
                            <div class="buttonbtn shituu selectbuttonbtn" title="">
    ...
    <script>
        $('.new-btn').click(function () {
            $('#changeDiv').show()
            $('#iframe').attr('src', '/alert/meeting/add_meeting.html')
        })
        function formatOper(val, row, index, entityType) {
            ...
            return '<a onclick=edit("' + rowId + '") style=\"color:#015ba7;font-size:13px;\" href="#">编辑</a>&nbsp;|&nbsp;<a onclick=deleteRow("' + rowId + '") style=\"color:#015ba7;font-size:13px;\" href="#">删除</a>';
            //return '<a style=\"color:#015ba7;font-size:13px;\" href="/' + entityType + '/detail?id=' + rowId + '">查看</a>&nbsp;<a onclick=edit("' + rowId + '") style=\"color:#015ba7;font-size:13px;\" href="#">编辑</a>&nbsp;';
        }
        function edit(id) {
            $('#changeDiv').show()
        ...
        function deleteRow(id) {
            ...
            if (confirm('您是否确认删除?')) {
                ...
                ajaxMethodGetData('entity.delete', d, callback)
            }
