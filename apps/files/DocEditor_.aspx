  ...
  //if (vIndex==-1){webform.WebOffice.Alert(vCaption);}     //在完成相应操作后响应iWebOffice标准工具栏操作铵钮事件，如"手写批注",vCaption="手写批注"
    ...
    <script language="javascript" type="text/javascript">
        ...
        */
        ...
        function WebTABALL() {
            //debugger;
            if (WebCreateHTML()) {  //调用完成生成HTML的函数
        ...
        function WebCreateHTML() {
            ...
            webform.WebOffice.WebSetMsgByName("FIELDNAME", "姓名");
        ...
        function WebUseTemplate() {
            var mDialogUrl = "TemplateForm.aspx";
  ...
  '</customUI>';
    ...
    <script type="text/javascript">
        function autoHeight() {
            ...
            //if (jQuery('#tableDJ').is(':visible')) {
             //   h -= 30;
            //}
            if (h < 700)
                h = 750;
            //alert(h);            
            jQuery('#tblOfficeObj1').height(h + 55);
            jQuery('#tblOfficeObj').height(h);
        }
...
<body bgcolor="#ffffff" onload="Load();autoHeight();" onunload="UnLoad()">
    <!--引导和退出iWebOffice-->
    ...
    <table border="0" cellspacing='0' cellpadding='0' width='100%' height="100%" align="center">
        <tr>
            <td style="width: 100%; padding: 5px;">
                ...
                <input type="button" value="保存HTML" onclick="WebSaveAsHtml()" />&nbsp;
                <input type="button" value="插入HTML" onclick="WebCreateHTMLField()" />&nbsp;
                <input type="button" value="插入远程HTML" onclick="WebTABALL()" />&nbsp;
                <input type="button" value="插入标签" onclick="SetBookmarks('Field','插入标签')" />&nbsp;
            </td>
        </tr>
    </table>-->
    <table width="100%" height="100%" id="tblOfficeObj1" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        <tr>
            <td align="right" valign="middle" height="30" width="100%" style="padding-right: 11px"
                ...
                <input type="button" class="btn_cxzr" onclick="javascript: LoadDocument(); return false;"
                    value="重新载入" />&nbsp;
                <input type=button class="btn_shuaxin" value="图片" <%=mDisabled%>  <%=mWord%>  onclick="WebInsertImage()">
                 <input type=button class="btn_shuaxin" value="套红模版" <%=mDisabled%>  <%=mWord%> onClick="WebUseTemplate()">
                <input type="button" class="btn_print" value="批注" onclick='javascript: WebInsertPostil(); return false;'>
                ...
                <input type="button" id="btnsavedb" class="btn_preserve" onclick="javascript: CallSave();" value="保存到数据库" />
            ...
            <td height="100%" colspan="6" rowspan="12" align="right" valign="top">
                <table border="0" id="tblOfficeObj" cellspacing="0" cellpadding="0" width="100%" style="height: 90%">
                    <tr>
                        <td bgcolor="menu" height="100%" valign="top">
                            ...
                            <object progid="iWebOffice2003.iWebOffice" id='WebOffice' type="application/iwebplugin" HEIGHT='100%' width="100%"
