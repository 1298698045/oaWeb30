...
<head>
    ...
    <title>更改我的工资密码 ~ 个人设置 - 高效协同</title>
                            ...
                            <div class="setup">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td id="bottomButtonRow" class="pbButtonb">
                                                         <input type="button" name="save" title="保存" class="primary btn" value=" 保存 " onclick="salaryPasswordSet()" >
                                ...
                                <script type="text/javascript">
                                    ...
                                    function validatePwd()
                                    {
                                        ...
                                        var oldPwd = document.getElementById("p4").value;
                                        ...
                                        var isValid = salaryOldPasswordValidation();
                                        if (!isValid) {
                                            alert("“旧密码”输入错误！");
                                            return false;
                                        }
                                    ...
                                    function salaryOldPasswordValidation() {
                                        var isValid = false;
                                        var oldPwd = document.getElementById("p4").value;
                                        var param = { password: oldPwd };
                                        var url = "bonus.salary.validation";
                                        ajaxMethodPOSTData(url, param, function (data) {
                                            console.log("salaryOldPasswordValidation data: " + data);
                                            if (data.status == 1) {
                                                isValid = true;
                                            }
                                            else {
                                    ...
                                    function salaryPasswordSet() {

                                        if (validatePwd()) {
                                            var newPwd = document.getElementById("p5").value;
                                            var param = { password: newPwd };
                                            var url = "bonus.salary.set";

                                            ajaxMethodPOSTData(url, param, function (data) {
                                                //console.log("salaryPasswordSet callback ");
                                                if (data.status == 1) {
