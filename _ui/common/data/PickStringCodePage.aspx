<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PickStringCodePage.aspx.cs" Inherits="WebClient._ui.common.data.PickStringCodePage" %>
...
<body onload="if(this.bodyOnLoad)bodyOnLoad();" onunload="if(this.bodyOnUnload)bodyOnUnload();"
    ...
    <div class="bFilter1" style="margin-top:5px;">
            ...
            &nbsp;&nbsp; <label for="searchValue_sharing_search">
                搜索：</label>&nbsp;<input type="text" size="20" name="searchValue_sharing_search"
                    maxlength="80" id="searchValue_sharing_search">&nbsp;<input type="button" title="查找"
                        ...
                        class="btn" value=" 查找 "><input type="button" name="save" title="所有数据" class="primary btn" value=" 所有 " onclick="LoadDepts()" /><br />
                ...
                <tbody>
                    <tr>
                        ...
                        <td id="topButtonRow" class="pbButton">
                            ...
                            <input type="submit" name="cancel" title="取消" class="btn" value=" 取消 " onclick="window.close();" />
                        </td>
                    </tr>
                </tbody>
            </table>
    ...
    <script type="text/javascript">
        ...
        function LoadDepts() {
            ...
            var enumId = jQuery("#EnumId").val();
            var attributeName = jQuery("#lknm").val();
            // shorthand
            var Tree = Ext.tree;
            //debugger
            var tree = new Tree.TreePanel({
                ...
                dataUrl: '/apps/CommandProcessor.ashx?cmd=getstringcode&AttributeName=' + attributeName + '&enumId=' + enumId,
                root: {
                    nodeType: 'async',
                    text: '请选择',
                    draggable: false,
        ...
        */
        ...
        function searchDepts() {
            ...
            var url = '/apps/CommandProcessor.ashx?cmd=getstringcode&AttributeName=' + jQuery("#lknm").val() + '&search=' + encodeURIComponent(srch);
            ...
            jQuery.ajax({
                ...
                success: function (data, textStatus) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        var item = data[i];
                        html += "<tr><td><a href='#' onclick=\"selectDept('" + item.text + "','" + item.text + "')\">" + item.text + "</a></td></tr>";
                    }
                    html += "</table>";
