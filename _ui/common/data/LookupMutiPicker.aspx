<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LookupMutiPicker.aspx.cs" Inherits="WebClient._ui.common.data.LookupMutiPicker" %>
...
<head>
    ...
    <script>
        function saveSelection()
        {
            ...
            var values = "";
            var sort = 0;
            jQuery("input[name^='chkbox']").each(function (index, value) {
            ...
            //alert(values);
            //top.window.opener.lookupPick('{0}', '{1}_lkid', '{1}', '', '{2}', '{3}', 'null', '');
            var lknm = document.getElementById("lknm").value;
            //debugger;
            if (top.window.opener.peopleLookupPick)
                top.window.opener.peopleLookupPick('editPage', lknm + '_lkid', lknm, '', values, names, 'null', '');
            else
                top.window.opener.peopleLookupPick('editPage', lknm + '_lkid', lknm, '', values, names, 'null', '');
            window.close();
        }
...
<body onload="if(this.bodyOnLoad)bodyOnLoad();" onunload="if(this.bodyOnUnload)bodyOnUnload();" class="hasMotif lookupTab  FilterLookupPage" onfocus="if(this.bodyOnFocus)bodyOnFocus();" onbeforeunload="if(this.bodyOnBeforeUnload){var s=bodyOnBeforeUnload();if(s)return s;}">
    <!-- Main Body Starts Here -->
    <div class="lookup"><!--
        <div class="bPageTitle">
            <div class="ptBody secondaryPalette">
                <div class="content">
                    <img src="/s.gif" alt="" class="pageTitleIcon" title="" /><h1>查找</h1>
                </div>
            </div>
        </div>-->
            <form action="/_ui/common/data/LookupMutiPicker.aspx" id="theForm" method="GET" name="theForm"
    ...
    <div class="lookup">
            ...
            <div class="pBody">
                <label class="assistiveText" for="lksrch">
                    搜索</label><input id="lksrch" maxlength="80" name="lksrch" placeholder="搜索..." size="20"
                        type="text" value='<%=Request["lksrch"] %>' /><input value=" 转至！ " class="btn" name="go"
                            title="转至！" type="submit" /><!--<input value=" 新建 " class="btn" name="new" onclick="javascript:top.resultsFrame.location='LookupResultsFrame?lktp=001&lkfm=editPage&lknm=con4&lksrch=Edge+Communications&lkenhmd=SEARCH_NAME&lknew=1&igdp=0'"
       ...
       <!-- <div class="pbBody">
            <h2>在下面选择要添加的选项列表值。</h2>
        </div>-->
        <div class="topButton">
            <input value=" 插入所选 " class="btn" name="Done" onclick="saveSelection();" title="插入所选" type="button" /></div>
        <a href="javascript:FilterLookupPage.prototype.checkAll%28false%29">取消全选</a>
        <!-- Begin ListElement -->
            ...
            <div class="bPageBlock brandSecondaryBrd secondaryPalette">
                ...
                <div class="pbBody">
                    <table class="list" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tbody style="overflow-y:yes;overflow:scroll;">
                       <%=HTMLGrid%></tbody>                    
                    </table>
                </div>
        ...
        <div class="bottomButton">
            <input value=" 插入所选 " class="btn" name="Done" onclick="saveSelection();" title="插入所选" type="button" /></div>
        <div class="footer">&copy; 2000-2016 .com, inc. 公司版权所有。 本公司保留所有权利。</div>
    </div>
    ...
    <!-- Body events -->
    <script type="text/javascript">function bodyOnLoad() { setFocusOnLoad(); if (typeof (startSessionTimer) != 'undefined') { startSessionTimer(); }; if (window.PreferenceBits) { window.PreferenceBits.prototype.csrfToken = "VmpFPSxNakF4TlMwd09TMHlORlF3TnpvMU9EbzBOUzQyTnpSYSxhNWs4LE1HVXdaalF3"; }; } function bodyOnBeforeUnload() { } function bodyOnFocus() { } function bodyOnUnload() { }</script>
</body>
</html>