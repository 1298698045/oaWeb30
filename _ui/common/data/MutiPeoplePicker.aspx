<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MutiPeoplePicker.aspx.cs"
    Inherits="WebClient._ui.common.data.MutiPeoplePicker" %>
            ...
            <div class="pbSubsection">
                <table cellspacing="0" cellpadding="0" border="0" class="detailList">
                    <tbody>
                        <tr class="detailRow">
                            <td>
                                <div id="deptContainer" class="pbSubsection" style="overflow-y: yes;width:180; height: 400px; overflow: auto;display:none;">
                                    <br/>
