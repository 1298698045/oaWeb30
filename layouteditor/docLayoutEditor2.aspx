...
<head>
    ...
    <link href="/sCSS/32.0/sprites/1418663684000/Theme3/base/dStandard.css" rel="stylesheet"
        type="text/css" />
    <link href="/sCSS/32.0/sprites/1426127703000/Theme3/00D90000000yvHG/0059000000390Wh/base/dCustom0.css"
...
<body onload="if(this.bodyOnLoad)bodyOnLoad();" onunload="if(this.bodyOnUnload)bodyOnUnload();"
                    ...
                    <td class="noSidebarCell">
                        ...
                        <center>
                            ...
                            <table width="100%" height="100%" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
                                ...
                                <tr>
                                    <td align="right" valign="middle" height="30" width="100%" style="padding-right: 11px" colspan="6">
                        ...
                        <!-- Body events -->
                        <script type="text/javascript">                            function bodyOnLoad() { if (typeof (startSessionTimer) != 'undefined') { startSessionTimer(); }; Load(); SetupTreeNode.prototype.initializeSetup(); if ((window.sfdcPage) && (sfdcPage.executeOnloadQueue)) { sfdcPage.executeOnloadQueue(); }; ; if (this.loadChatFrameJs) loadChatFrameJs(); SearchClickLoggingUtil.setClickLoggingServletPath("/_ui/search/logging/SearchClickLoggingServlet"); new UnifiedSearchAutoCompleteElement("phSearchInput", "/_ui/common/search/client/ui/UnifiedSearchAutoCompleteServlet", 1, {}, false, null, "phSearchForm", ["div", "searchOwner", "asPhrase", "sen"], {}, true, 3, 100); new UnifiedSearchButton("searchButtonContainer", "phSearchButton", "headerSearchRightRoundedCornerMouseOver", "phSearchForm"); new GhostTextInputWrapperElement('setupSearch', '搜索所有设置...', 'quickFindInput version2', 'quickfindInput ghostText version2', null, null, true); if (window.PreferenceBits) { window.PreferenceBits.prototype.csrfToken = "WNweQtDxafWHPl11AE8hq.9s2GgnOlNNRIyOH4P3.3YuG2ICbQWo_td97HODsP79MNxFyANA.eM2HAAt2pmiXt4nMW7b0BydW5w6Dtbv39zVTAJ4ENGuLwqcFVe7unVyCRqAUfZKnbAUoDFKgvAhGgzZVCr_M8WMmPadS.DMITAUr5puN_n7mV4EFZBbKHD2eNPfhg=="; }; } function bodyOnBeforeUnload() { if ((window.sfdcPage) && (sfdcPage.executeOnBeforeUnloadQueue)) { sfdcPage.executeOnBeforeUnloadQueue(); }; } function bodyOnFocus() { closePopupOnBodyFocus(); } function bodyOnUnload() { }</script>
                        <!-- End page content -->
                    </td>
                </tr>
            </table>
    ...
    <!--<script>        var SFDCSessionVars = { "uid": "", "exp": 1426647298000, "host": "login..com", "oid": "", "server": "https://login..com/login/sessionserver190.html", "act": "u" };</script>-->
