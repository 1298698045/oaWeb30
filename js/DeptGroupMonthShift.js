...
var copyData = {}
{
    ...
    attendanceEditor.prototype.rendertable = function () {
        ...
        var that = this
        this.loadData("workshift.month.deptgroup.employee.getlist", prea, function (data) {
    ...
    attendanceEditor.prototype.loadDesigner = function (para) {
        ...
        this.loadData("workshift.month.deptgroup.headerinfo.get", para, function (data) {
            ...
            self.para += "&md0=" + data.Year;
            self.para += "&md1=" +data.Month;
...
function hover1() {
    ...
    $('.shift-hover1 #hovercancel').off("click");
...
function printAttenanceCalendar() {
    ...
    var url = "/attd/shifts/prtEmpDeptGroupShifts.aspx?objectTypeCode=30041&md0=" + attendYear + "&md1=" + attendMonth + "&md2=0&unitId=" + DeptId + "&calendar=" + 1 + "&showMemo=" + 0 + "&GroupId=" + GroupId + "&DeptId=" + DeptId + "&startDate=" + startDate + "&endDate=" + endDate;
