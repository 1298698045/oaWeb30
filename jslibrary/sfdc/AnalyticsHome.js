...
Ext.isEmpty(this._currentPage)||(this.pageState.value=this._currentPage,delete this._currentPage)},initdd:function(){var a=
this;this.drag=new Ext.dd.DragZone(this.grid.getEl(),{containerScroll:!0,scroll:!1,ddGroup:"GridToTree",rowId:"",getDragData:function(b){if(b=b.getTarget("div.x-grid3-row")){b=Ext.get(b).select(".x-grid3-col-NAME",!0).elements[0];var c=document.createElement("div");c.className="dragElement";c.id="analyticsHomeDnDProxy";var d=a.drag.row.data.NAME;Sfdc.Dom.updateHTML(c,"object"==typeof d?d[0]:d);return{ddel:c,rowId:a.drag.row.id,repairXY:b.getXY()}}},getRepairXY:function(){return this.dragData.repairXY}});
this.grid.on("rowmousedown",function(b,c,d){a.drag.row=b.getStore().getAt(c)})},_setHashState:function(){var a=Sfdc.analytics.home.AnalyticsHome.HASH_STATE;a&&(this.lastSearchTerm=a.search,this._currentFolderId=a.fcf,this._currentFolderType=a.folderType,this._currentStandardFolderKey=a.sfk,this._currentSort=a.sort,this._currentEntityType=a.entityType,this._currentScope=a.scope,this._currentPage=a[this.domId+"_pageState"])},_setFilterState:function(a,b){Ext.isEmpty(a.sort)||(this._currentSort=a.sort);
...
a.search=b.search||this.lastSearchTerm||""},getShowRefreshLink:function(){return!1},getGridListeners:function(){var a=Sfdc.analytics.home.AnalyticsHomeListViewport.superclass.getGridListeners.call(this),
b = function (a, b, e, g) {
    if (this.hasActions) {
...
b=function(a){if(a.enableColumnMove){var b=a.getView();
...
a.afterrender?a.afterrender.createSequence(b,this):a.afterrender={fn:b,scope:this};return a},isInitialized:function(){return this.firstUpdateDone},updatePage:function(a){Sfdc.analytics.home.EventManager.fireEvent("listDataUpdated",this, a);
...
this.sortState=a.sortState;this.firstUpdateDone||(Sfdc.analytics.home.EventManager.fireEvent("listViewInitialized"),
this.firstUpdateDone=!0)},afterResize:function(){this.updateSortStateHack(this.sortState)},getDefaultColumnWidth:function(a){var b=a.columnName;a=Sfdc.analytics.home.AnalyticsHomeListViewport.superclass.getDefaultColumnWidth.call(this,a);"NAME"==b?a=315:"FOLDER_NAME"==b?a=100:"CREATED_BY_NAME"==b?a=100:"CRON_TRIGGER_ID"==b?a=46:"ENTITY_SUBSCRIPTION_ID"==b&&(a=46);return a},buildColumnConfig:function(a,b){var c=Sfdc.analytics.home.AnalyticsHomeListViewport.superclass.buildColumnConfig.apply(this,arguments);
"CRON_TRIGGER_ID"==a.columnName&&(c.tooltip=c.header,c.header='\x3cimg src\x3d"/s.gif" class\x3d"scheduledIcon" '+((Ext.QuickTips.isEnabled?"ext:qtip":"title")+'\x3d"'+c.tooltip+'"')+"/\x3e");return c},buildActionColumn:function(a,b){var c=Sfdc.analytics.home.AnalyticsHomeListViewport.superclass.buildActionColumn.call(this,a,b);c.tooltip=c.header;c.hidden=!1;c.resizable=!1;c.width=60;return c},_setValueAndDisableIfNotDisabled:function(a,b,c){a.disabled||this._setValueAndDisable(a,b,c)},_restoreValueAndEnable:function(a,
b,c){this._setValueAndEnable(a,b,void 0!==this._userFilterSelectionsOnAllFolders[b]?this._userFilterSelectionsOnAllFolders[b]:c)},_setStateAndComboboxValue:function(a,b,c){this[b]=c;a.setValue(c)},_setValueAndDisable:function(a,b,c){this._setStateAndComboboxValue(a,b,c);a.disable()},_setValueAndEnable:function(a,b,c){this._setStateAndComboboxValue(a,b,c);a.enable()},_setStateAndComboBoxValueIfNotDisabled:function(a,b,c){a.disabled||this._setStateAndComboboxValue(a,b,c)},_isAllFoldersNode:function(a,
b,c){return Ext.isEmpty(a)&&Ext.isEmpty(b)&&(void 0===c||Ext.isNumber(c)&&0>c)},_isOnAllFoldersNode:function(){return this._isAllFoldersNode(this._currentFolderId,this._currentFolderType,this._currentStandardFolderKey)},_clearSearchBox:function(){this.lastSearchTerm="";this.searchBox.setValue("");this.searchBox.trigger.hide()},_adjustEntityAndScopeFilters:function(){this._isOnAllFoldersNode()?(this._entityTypeCombo&&this._restoreValueAndEnable(this._entityTypeCombo,"_currentEntityType",""),this._restoreValueAndEnable(this._scopeFilterCombo,
"_currentScope", "noFilter")) :
Ext.isNumber(this._currentStandardFolderKey)&&0<=this._currentStandardFolderKey?(this._entityTypeCombo&&this._setValueAndDisableIfNotDisabled(this._entityTypeCombo,"_currentEntityType","00O"),this._setValueAndDisableIfNotDisabled(this._scopeFilterCombo,"_currentScope","noFilter")):(this._entityTypeCombo&&this._setValueAndEnable(this._entityTypeCombo,"_currentEntityType",""),this._setValueAndEnable(this._scopeFilterCombo,"_currentScope","noFilter"))},_attachEventListeners:function(){var a=
Sfdc.analytics.home.EventManager;
...
}, getDefaultText: function () { var a = this._defaultSearchText; delete this._defaultSearchText; return a }, search: function (a) {
    1 === a.length ? a = "" : (this._setStateAndComboBoxValueIfNotDisabled(this._scopeFilterCombo, "_currentScope", "noFilter"), this._entityTypeCombo && this._setStateAndComboBoxValueIfNotDisabled(this._entityTypeCombo, "_currentEntityType", ""));
        Sfdc.analytics.home.AnalyticsHomeListViewport.superclass.search.call(this,a)},wireSearchBox:function(){Sfdc.analytics.home.AnalyticsHomeListViewport.superclass.wireSearchBox.call(this);this.searchBox&&this.lastSearchTerm&&(this.searchBox.setValue(this.lastSearchTerm),this.searchBox.trigger.show())},_setupFilters:function(){Ext.onReady(function(){var a=Ext.get(this.domId+"_entityType");a&&(Ext.isEmpty(this._currentEntityType)||(a.dom.value=this._currentEntityType),this._entityTypeCombo=new Ext.form.ComboBox({listClass:"entityFilterList",ctCls:"entityFilter",width:160,listWidth:"auto",
transform:a,editable:!1,disabled:"disabled"===a.getAttribute("disabled")||-1<this._currentStandardFolderKey,triggerAction:"all",listAlign:["tr-br?",[18,0]],listeners:{scope:this,beforeselect:function(a,c,d){(c=a.getValue()!=c.get(a.valueField))||a.collapse();return c},select:function(a,c,d){this._currentEntityType=c.get(a.valueField);this._isOnAllFoldersNode()&&(this._userFilterSelectionsOnAllFolders._currentEntityType=this._currentEntityType);this.getListData()}}}),this._currentEntityType=this._entityTypeCombo.getValue(),
this._isOnAllFoldersNode() && (this._userFilterSelectionsOnAllFolders._currentEntityType = this._currentEntityType));
...
beforeselect:function(a,c,d){(c=a.getValue()!=c.get(a.valueField))||a.collapse();return c},select:function(a,c,d){this._currentScope=c.get(a.valueField);this._isOnAllFoldersNode()&&(this._userFilterSelectionsOnAllFolders._currentScope=this._currentScope);"recentlyViewed"===this._currentScope&&(this._currentSort="");this.getListData()}}}),this._currentScope=this._scopeFilterCombo.getValue(),this._isOnAllFoldersNode()&&(this._userFilterSelectionsOnAllFolders._currentScope=this._currentScope)}.createDelegate(this))},
_canMoveItemToFolder:function(a,b){var c=a.type,d=b.substring(0,3),e=this._getRowIndexOfItem(b),g=this._perRowValueArrays._folderIds[e],f=this._getCurrentRecord(b),h=this._perRowValueArrays.itemEditabilities[e],k=this._perRowValueArrays._toVisibleFolderMovabilities[e],e=this._perRowValueArrays.itemDashboardMoveToPersonalFolder[e];if("01Z"===d&&"005"===a.fid.substring(0,3)&&!e||f.isNotDraggable||g===a.fid||!("a"==c&&("00O"==d||"01Z"==d)||"b"==c&&"01Z"==d||"r"==c&&"00O"==d))return!1;c=a.sfk;return Ext.isNumber(c)&&
0<=c?!1:(a.canAddToFolder||k)&&h?!0:!1},_getCurrentRecord:function(a){return this.grid.getStore().getById(a)},_getRowIndexOfItem:function(a){var b=this.grid.getStore();a=b.getById(a);return b.indexOf(a)},_getRow:function(a){a=this._getRowIndexOfItem(a);return this.grid.view.getRow(a)}})};
Ext.namespace("sfdc.analytics.home");
...
Ext.namespace("Sfdc.analytics.home");
Sfdc.analytics.home.FolderActionRegistry=function(){var f=function(e,c){var d=c.isSelected(),a=c.parentNode,b=c.attributes.folderTree;c.remove();a=a.firstChild;d&&(null!==a?b.switchFolder(a):b.switchToFolder({fid:"",type:"",origText:LC.getLabel("analyticsHome","AllFoldersText")}));null===a&&b.appendNoResultsNode(b.getRootNode())};return{getMenuItem:function(e,c){var d=null,a=e.action,b=e.extraInfo,g=c.attributes;"EDIT"==a?d={text:b.label,href:b.url}:"DELETE"==a?d={text:b.label,handler:function(a){Modal.confirm(LC.getLabel("Global",
"are_you_sure"))&&(new sfdc.analytics.framework.EntityDeleter(g.fid,b.csrf,f.createDelegate(this,[a],!0))).deleteEntity()}.createCallback(c)}:"SHARE"==a?d={text:b.label,handler:function(a){Sfdc.analytics.home.EventManager.fireEvent("editSharingSettings",a.attributes.fid)}.createCallback(c)}:"PIN"==a?d={text:b.label,handler:function(a){Sfdc.analytics.home.EventManager.fireEvent("pinFolder",a)}.createCallback(c)}:"UNPIN"==a?d={text:b.label,handler:function(a){Sfdc.analytics.home.EventManager.fireEvent("unpinFolder",
a)}.createCallback(c)}:"SEPARATOR"==a&&(d={xtype:"menuseparator"});return d}}}();
Ext.namespace("Sfdc.analytics.home");
...
Sfdc.analytics.home.AnalyticsFilterDelegate.prototype = {
    ...
    getActionMenuItems: function (b, c, a) {
        var e = c.get(ListView.ID_COLUMN),
            d = [];
        Ext.each(a, function (a) {
            var f = a.action, g = a.extraInfo;
            //@@TODO added
            if ("PREVIEW" == f )
                d.push(this._createStandardLink(a));

            "EDIT" == f ? d.push(this._createStandardLink(a)) : "DELETE" == f ? d.push({
                    text: g.label,
                    handler: function (a) {
                        a = function () {
...
Sfdc.analytics.home.FolderTree = function (a) {
    ...
    var e = {
        xtype: "container",
        cls: "folderText",
        html: LC.getLabel("udd_Folder", "Entities")
    },
        l = new Ext.tree.AsyncTreeNode({
            expanded: !1
        });
    this.searchBox = new Sfdc.html.QuickfindInput({
        ...
        scope: this,
        emptyText: LC.getLabel("analyticsHome", "folderSearch"),
        buffer: 300,
        region: "center",
        margins: {
            top: 3,
    ...
    var g = this._getFolderMenuItems(),
        d = [this.searchBox];
    0 < g.length && d.push({
        xtype: "button",
        cls: "addFolder",
    ...
    d.addListener("selectionchange", function (a, b) {
        this.switchFolder(b)
    } .createDelegate(this));
...
Sfdc.analytics.home.FolderTreeNodeUI = Ext.extend(Ext.tree.TreeNodeUI, {
    constructor: function (a) {
        ...
        Sfdc.analytics.home.FolderTreeNodeUI.superclass.constructor.call(this,
            a)
    },
    render: function () {
    ...
    _createMenuItem: function (a) {
        var b = a.attributes,
            e = [],
            c, l = Sfdc.analytics.home.FolderActionRegistry,
            g = !0;
        Ext.each(b.actions, function (d) {
            if (c = l.getMenuItem(d, a))
                if ("PIN" === d.action &&
                    "false" === b.isPinned && !b.folderTree._canPinFolder) g = !1;
                else {
...
Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings=function(){return{init:function(a){Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.LABELS={ALL:LC.getLabel("analyticsSharing","all"),AND:LC.getLabel("analyticsSharing","and"),SEARCH_MORE:LC.getLabel("analyticsSharing","tooManyRows"),VIEWER:LC.getLabel("analyticsSharing","viewer"),MANAGER:LC.getLabel("analyticsSharing","manager"),EDITOR:LC.getLabel("analyticsSharing","editor"),CLOSE:LC.getLabel("analyticsSharing","close"),SHARE:LC.getLabel("analyticsSharing",
"share"),SHARING_SETTINGS:LC.getLabel("analyticsSharing","sharingSetting"),SHARE_WITH:LC.getLabel("analyticsSharing","shareWith"),SHARED_WITH:LC.getLabel("analyticsSharing","sharedWith"),STOP_SHARING_HOVER_TEXT:LC.getLabel("analyticsSharing","stopSharingHover"),ACCESS:LC.getLabel("analyticsSharing","permissions"),ACCESS_HOVER_TEXT:LC.getLabel("analyticsSharing","permissionsHoverText"),SHARED:LC.getLabel("analyticsSharing","shared"),LOADING:LC.getLabel("analyticsSharing","loading"),DONE:LC.getLabel("analyticsSharing",
"done"),NO_SEARCH_RESULTS:LC.getLabel("analyticsSharing","noSearchResults"),NO_RESULTS:function(a){return LC.getLabel("analyticsSharing","noResults",a)},DEFAULT_SEARCH_TEXT:LC.getLabel("analyticsSharing","defaultSearchText")};Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.DIALOG_HELP_URL=a;a='\x3ca class\x3d"permissionCellText" id\x3d"permissionMenu_{ugId}"\x3e\x3ctpl if\x3d"shared !\x3d\x3d true"\x3e\x3c/tpl\x3e\x3ctpl if\x3d"shared \x3d\x3d true \x26\x26 shareLevel \x3d\x3d \'VIEW_\'"\x3e'+
...
var b='\x3ctd\x3e\x3ca href\x3d"javascript:void(null);"\x3e\x3cimg class\x3d"deleteCell" title\x3d"'+Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.LABELS.STOP_SHARING_HOVER_TEXT+'" alt\x3d"'+Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.LABELS.STOP_SHARING_HOVER_TEXT+'" src\x3d"/s.gif" id\x3d"deleteRow_{ugId}"\x3e\x3c/a\x3e\x3c/td\x3e',d='\x3ctd class\x3d"shareLabelCell" id\x3d"shareButtonOrLabel_{ugId}"\x3e\x3ctpl switch\x3d"shareLevel"\x3e\x3ctpl case\x3d\'VIEW_\' case\x3d\'EDIT_ALL_CONTENTS\' case\x3d\'MANAGE\'\x3e\x3clabel class\x3d"addedText"\x3e'+
Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.LABELS.SHARED+'\x3c/label\x3e\x3c/tpl\x3e\x3ctpl default\x3e\x3cbutton class\x3d"addButton" id\x3d"addButton_{ugId}"\x3e'+Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.LABELS.SHARE+"\x3c/button\x3e\x3c/tpl\x3e\x3c/tpl\x3e\x3c/td\x3e";Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.DIALOG=new Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettingsDialog;var e='\x3cimg id\x3d"sharingPermissionsHelpIcon" class\x3d"infoIcon" title\x3d"" alt\x3d"" src\x3d"/s.gif" onmouseover\x3d"addMouseOver(getElementById(\'sharingHelpTextMouseOverOuter\'), this, \'left\')"  onfocus\x3d"addMouseOver(getElementById(\'sharingHelpTextMouseOverOuter\'), this, \'left\')"\x3e\x3cdiv id\x3d"sharingHelpTextMouseOverOuter" class\x3d"mouseOverInfoOuter"\x3e\x3cdiv class\x3d"mouseOverInfo" style\x3d"display: none;"\x3e'+
Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.LABELS.ACCESS_HOVER_TEXT+"\x3c/div\x3e\x3c/div\x3e";Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.viewSharingHeader=['\x3ctable class\x3d"sharingViewTable"\x3e\x3ctr class\x3d"listHeader"\x3e\x3cth class\x3d"dataCell"\x3e\x3c/th\x3e\x3cth class\x3d"sharedWithLabel labelColor"\x3e\x3cspan id\x3d"allCount"\x3e\x3c/span\x3e\x3c/th\x3e\x3cth class\x3d"accessCell labelColor"\x3e',e,Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.LABELS.ACCESS,
'\x3c/th\x3e\x3cth class\x3d"dummyCell"/\x3e\x3c/tr\x3e\x3c/table\x3e'].join("");Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.VIEW_TEMPLATE=new Ext.XTemplate('\x3ctable class\x3d"sharingViewTable"\x3e','\x3ctpl for\x3d"."\x3e','\x3ctr class\x3d"baseRow added {cls}" \x3e','\x3ctd class\x3d"dataCell"\x3e{shareId:"{shareId}", ugId:"{ugId}", groupType:"{groupType}", shareLevel:"{shareLevel}", shared:{shared}, isPortal:{isPortal}}\x3c/td\x3e','\x3ctd class\x3d"shareNameCell"\x3e\x3cdiv\x3e\x3cdiv class\x3d"nameText" title\x3d"{ugTitle}"\x3e{ugName}\x3c/div\x3e\x3cdiv class\x3d"groupTypeText"\x3e{groupTitle}\x3c/div\x3e\x3c/div\x3e\x3c/td\x3e',
'\x3ctd class\x3d"permissionCell"\x3e'+a+"\x3c/td\x3e",b,"\x3c/tr\x3e","\x3c/tpl\x3e","\x3c/table\x3e");Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.VIEW_TEMPLATE.compile();Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.addSharingHeader=['\x3ctable class\x3d"sharingViewTable"\x3e\x3ctr class\x3d"listHeader"\x3e\x3cth class\x3d"dataCell"\x3e\x3c/th\x3e\x3cth class\x3d"sharedWithLabel"\x3e\x3cdiv id\x3d"addTab" class\x3d"active"\x3e\x3c/div\x3e\x26nbsp;|\x26nbsp;\x3cdiv id\x3d"addedTab"\x3e',
Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.LABELS.SHARED,'\x26nbsp;(\x3cspan id\x3d"addedCount"\x3e0\x3c/span\x3e)\x3c/div\x3e\x3c/th\x3e\x3cth class\x3d"dummyCell"\x3e\x3c/th\x3e\x3cth class\x3d"accessCell labelColor"\x3e',e,Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.LABELS.ACCESS,"\x3c/th\x3e\x3cth\x3e\x3c/th\x3e\x3c/tr\x3e\x3c/table\x3e"].join("");a=new Ext.XTemplate('\x3ctable class\x3d"sharingViewTable"\x3e','\x3ctpl for\x3d"."\x3e','\x3ctr class\x3d"baseRow {[(values.shared \x3d\x3d\x3d true)? "added" : "notAdded"]} {cls}"\x3e',
...
"\x3c/td\x3e","\x3c/tr\x3e",'\x3ctr class\x3d"message fake" id\x3d"noSearchResultsRow"\x3e',"\x3ctd colspan\x3d4\x3e"+Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.LABELS.NO_SEARCH_RESULTS+"\x3c/td\x3e","\x3c/tr\x3e",'\x3ctr class\x3d"message fake" id\x3d"noResultsRow"\x3e','\x3ctd colspan\x3d4\x3e\x3cspan id\x3d"noResultRowsMessageHolder"\x3e0\x3c/span\x3e\x3c/td\x3e',"\x3c/tr\x3e","\x3c/table\x3e");a.compile();Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.dialogTemplate=
a;Sfdc.analytics.home.EventManager.addListener("editSharingSettings",function(a){Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.DIALOG.showDialog(a)})}}}();
Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettingsDialog=Ext.extend(Ext.util.Observable,{constructor:function(){Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettingsDialog.Events={RESPONSE:"response",ERROR:"error"};this.addEvents(Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettingsDialog.Events.RESPONSE);this.serverProxy=Sfdc.analytics.home.ServerProxy;this.serverProxy.addListener(Sfdc.analytics.home.ServerProxy.Events.RESPONSE,function(a){!0===a.success?(this.fireEvent(Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettingsDialog.Events.RESPONSE,
a.result),Ext.getCmp("folderShareErrorMessageBoxContainer").hide(),this._setSharingSettingsStickyHeader()):(Ext.isDefined(Ext.getCmp("folderShareErrorMessageBox"))&&(Ext.getCmp("folderShareErrorMessageBox").setText(a.errorMessage),Ext.getCmp("folderShareErrorMessageBoxContainer").show(),this._setSharingSettingsStickyHeader()),this._hideMask(),this.fireEvent(Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettingsDialog.Events.ERROR,a.result));this.purgeListeners()},this,{scope:this});var a=this._getNewWindowConfig();
this.cancelButton=a.buttons[0];this.window=new Ext.Window(a);this.window.render(Ext.getBody());this.windowMask=new Ext.util.DelayedTask(function(){this.window.getEl().mask(Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.LABELS.LOADING)},this);this.sharedCount=0},showDialog:function(a){this.folderId=a;this._showSharingSettingsDialog()},_showMask:function(){Ext.isDefined(this.window.getEl())&&this.windowMask.delay(500)},_hideMask:function(){Ext.isDefined(this.window.getEl())&&(this.windowMask.cancel(),
this.window.getEl().unmask())},_setSharingSettingsStickyHeader:function(){var a=Ext.get("sharingView"),b=Ext.get("stickyHeader"),d=a.select("table.sharingViewTable").first(),e=b.select("table.sharingViewTable").first(),f=Ext.get("folderShareErrorMessageBoxContainer");b.position("relative");var g=270;Ext.isIE7&&a.setHeight(g);var h=d.getBorderWidth("t")+d.getBorderWidth("l");e.setStyle("margin-bottom",(-1*h).toString()+"px");f.isVisible()&&(h=f.getMargins(),f=h.top+h.bottom+f.getHeight(),g-=f);a.setHeight(g-
b.getHeight());a=document.getElementById("sharingView");b.setWidth(a.clientWidth);b=d.select("td.shareNameCell").first();e.select("th.sharedWithLabel").first().setWidth(b.getWidth())},_showSharingSettingsDialog:function(){this.window.purgeListeners();this._showMask();this.addListener(Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettingsDialog.Events.RESPONSE,function(a){this.title=a.title;this._hideMask();this.canManage=a.canManage;this.sharedCount=a.sharedCount;var b=[],d=[],e={},f={};this.MAX_SHOWN_CATS=
3;for(var g=a.groups.length>this.MAX_SHOWN_CATS,h="",c=0;c<(!0===g?this.MAX_SHOWN_CATS:a.groups.length);c++)h=c+1<a.groups.length?LC.getLabel("analyticsSharing","lineWithComma",a.groups[c].label):a.groups[c].label,b.push({xtype:"container",id:a.groups[c].groupTag+"Link",cls:"dialogLink",arg:a.groups[c].groupTag,label:a.groups[c].label,items:[{html:'\x3ca href\x3d"javascript:void(null);"\x3e'+h+"\x3c/a\x3e"}]});if(!0===g){e={cls:"and",html:'\x3ca href\x3d"javascript:void(null);"\x3e'+Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.LABELS.AND+
"\x3c/a\x3e"};for(f=a.groups.length-this.MAX_SHOWN_CATS;c<a.groups.length;c++)d.push({xtype:"menuitem",id:a.groups[c].groupTag+"Link",handler:this._showAddShareDialogFromMenu.createDelegate(this,[a.groups[c].groupTag,a.groups[c].label],!0),text:a.groups[c].label});f={id:"extraLinkMenu",xtype:"button",text:LC.getLabel("analyticsSharing","x_more",f),cls:"menuButton",menuAlign:"tr-br?",menu:{cls:"extraCategoryMenu",items:d,id:"extraCategoryId"}}}d=[{xtype:"container",cls:"shareWithOuter "+(!0===this.canManage?
"manage":"view"),items:[{xtype:"container",layout:"hbox",height:20,hidden:!this.canManage,cls:"shareWith",items:[{xtype:"container",html:'\x3cimg class\x3d"shareWithIcon" src\x3d"/s.gif"\x3e'},{xtype:"label",text:Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.LABELS.SHARE_WITH+": "},b,e,f]},{id:"stickyHeader",xtype:"container",html:Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.viewSharingHeader},{xtype:"dataview",tpl:Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.VIEW_TEMPLATE,
itemSelector:"tr.baseRow",style:"overflow-x: hidden; overflow-y: auto;",overClass:"over",store:this._getDataStoreWithData(a.shares),id:"sharingView",height:270}]}];this._showWindow(d);this.window.setTitle(Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.LABELS.SHARING_SETTINGS+": "+a.title);Ext.get("allCount").dom.innerHTML=LC.getLabel("analyticsSharing","all",this.sharedCount);this.cancelButton.setText(Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.LABELS.CLOSE);this.cancelButton.handler=
function(){this.window.hide()};this._setUpActionMenuOnPermissionCell({conditional:function(a,c){return Ext.isDefined(Ext.get(a.target).findParent(".permissionCell"))&&this.canManage},callBackOnMenuChoose:function(a,c,b,g,h){var d=Ext.get(a.findParent("tr"));a=this._getSharesFromRowElement(d,b.api);this.addListener(Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettingsDialog.Events.ERROR,function(){d.query(".permissionCellText")[0].innerHTML=h},this,{single:!0,scope:this});this.serverProxy.commitShares(this.folderId,
Sfdc.analytics.home.ServerProxy.COMMIT_ACTION.UPDATE,a)},onDelete:function(a,c){var b=Ext.get(Ext.get(c).findParent("tr")),g=this._getSharesFromRowElement(b,"VIEW_");this.addListener(Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettingsDialog.Events.RESPONSE,function(){Ext.get(b).remove();this.sharedCount--;Ext.get("allCount").dom.innerHTML=LC.getLabel("analyticsSharing","all",this.sharedCount)},this,{single:!0,scope:this});this.serverProxy.commitShares(this.folderId,Sfdc.analytics.home.ServerProxy.COMMIT_ACTION.REMOVE,
g)}},this);!0===this.canManage&&Ext.each(b,function(a,c){Ext.get(a.id).on("click",function(){this._showAddShareDialog(a.arg,a.label)},this,{single:!0,scope:this})},this);this._setSharingSettingsStickyHeader()},this,{single:!0,scope:this});this.serverProxy.getAllShared(this.folderId)},_showAddShareDialogFromMenu:function(a,b,d,e){this._showAddShareDialog(d,e,!1)},_showAddShareDialog:function(a,b,d){this._showMask();this.window.purgeListeners();this.window.setTitle(Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.LABELS.SHARE_WITH+
" "+b+": "+this.title);this.cancelButton.setText(Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.LABELS.DONE);this.cancelButton.handler=function(){this._showSharingSettingsDialog()};this.window.on("beforehide",function(){this._showSharingSettingsDialog();return!1},this,{single:!0,scope:this});this.addListener(Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettingsDialog.Events.RESPONSE,function(e){this._hideMask();var f=this._getDataStoreWithData(e.shares);this.sharedCount=e.sharedCount;
this._showWindow([{xtype:"container",cls:"manage",items:[{xtype:"container",items:[{xtype:"container",layout:"hbox",height:25,cls:"sharingSearchBoxContainer",id:"sharingSearchBoxContainer"},{id:"stickyHeader",xtype:"container",html:Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.addSharingHeader},{xtype:"dataview",tpl:Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.dialogTemplate,store:f,id:"sharingView",itemSelector:"tr.baseRow",overClass:"over",style:"overflow-x: hidden; overflow-y: auto;",
trackOver:!0,height:270,listeners:{afterrender:function(a){Ext.get("noResultsRow").hasClass("fake")||Ext.get("noResultsRow").addClass("fake");1===a.getStore().getCount()&&Ext.isDefined(a.getStore().getById("fakeRow"))&&Ext.get("noResultsRow").removeClass("fake")},aftersearch:function(a,b){Ext.get("noSearchResultsRow").hasClass("fake")||Ext.get("noSearchResultsRow").addClass("fake");1===a.getStore().getCount()&&Ext.isDefined(a.getStore().getById("fakeRow"))&&Ext.get("noSearchResultsRow").removeClass("fake");
!0===b&&Ext.get("messageRow").removeClass("fake")}}}]}]}]);Ext.get("addTab").dom.innerHTML=b;Ext.get("addedCount").dom.innerHTML=this.sharedCount;Ext.get("noResultRowsMessageHolder").dom.innerHTML=Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.LABELS.NO_RESULTS(b);this._activeOnAddedTab(d);0<this.sharedCount&&Ext.get("addedTab").addClass("active");!0!==d&&!0===e.hasMore&&Ext.get("messageRow").removeClass("fake");this._setUpActionMenuOnPermissionCell({conditional:function(a,b){return Ext.isDefined(Ext.get(a.target).findParent(".permissionCell"))&&
Ext.get(Ext.get(b).findParent("tr")).hasClass("added")},callBackOnMenuChoose:function(a,b,c,d,e){var f=Ext.get(a.findParent("tr"));a=this._getSharesFromRowElement(f,c.api);this._showMask();this.addListener(Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettingsDialog.Events.ERROR,function(){f.query(".permissionCellText")[0].innerHTML=e},this,{single:!0,scope:this});this.addListener(Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettingsDialog.Events.RESPONSE,function(){this._hideMask()},this,
{single:!0,scope:this});this.serverProxy.commitShares(this.folderId,Sfdc.analytics.home.ServerProxy.COMMIT_ACTION.UPDATE,a)},onDelete:function(a,b){var c=Ext.get(Ext.get(b).findParent("tr")),d=this._getSharesFromRowElement(c,"VIEW_");this._showMask();this.addListener(Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettingsDialog.Events.RESPONSE,function(){this._hideMask();Ext.get(c).removeClass("added");Ext.get(c).addClass("notAdded");c.query(".permissionCellText")[0].innerHTML="";this.sharedCount--;
Ext.get("addedCount").dom.innerHTML=this.sharedCount;0===this.sharedCount&&Ext.get("addedTab").removeClass("active")},this,{single:!0,scope:this});this.serverProxy.commitShares(this.folderId,Sfdc.analytics.home.ServerProxy.COMMIT_ACTION.REMOVE,d)}});e=function(d,e){"addedTab"==d.target.id&&Ext.get(d.target).hasClass("active")&&this._showAddShareDialog(a,b,!0);"addTab"==d.target.id&&this._showAddShareDialog(a,b,!1);if("addButton"==d.target.className){var c=Ext.get(Ext.get(e).findParent("tr")),f=this._getSharesFromRowElement(c,
"VIEW_");this._showMask();this.addListener(Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettingsDialog.Events.RESPONSE,function(a){this._hideMask();c.query(".permissionCellText")[0].innerHTML=Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.LABELS.VIEWER;c.addClass("added");c.removeClass("notAdded");this._setSharesToRowElement(c,a.shares[0]);this.sharedCount++;1===this.sharedCount&&Ext.get("addedTab").addClass("active");Ext.get("addedCount").dom.innerHTML=this.sharedCount},this,{single:!0,
scope:this});this.serverProxy.commitShares(this.folderId,Sfdc.analytics.home.ServerProxy.COMMIT_ACTION.ADD,f)}};Ext.get("sharingView").on("click",e,this);Ext.get("stickyHeader").on("click",e,this);e=function(d){this._showMask();Ext.get("searchBox").removeClass("done");this.addListener(Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettingsDialog.Events.RESPONSE,function(a){this._hideMask();dataview=Ext.getCmp("sharingView");dataview.tpl=Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.dialogTemplate;
dataview.itemSelector="tr.baseRow";dataview.bindStore(this._getDataStoreWithData(a.shares));dataview.fireEvent("aftersearch",dataview,a.hasMore);this.sharedCount=a.sharedCount;Ext.get("addTab").dom.innerHTML=b;Ext.get("addedCount").dom.innerHTML=this.sharedCount;0<this.sharedCount&&Ext.get("addedTab").addClass("active");this._activeOnAddedTab(!1);Ext.get("searchBox").addClass("done")},this,{single:!0,scope:this});this.serverProxy.getUnsharedPerGroupType(this.folderId,a,d)};this.searchBox=new Sfdc.html.QuickfindInput({id:"searchBox",
renderTo:"sharingSearchBoxContainer",searchFunction:e,clearFunction:e.createDelegate(this,[""]),scope:this,disabled:1===f.getCount()&&f.getById("fakeRow"),emptyText:Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.LABELS.DEFAULT_SEARCH_TEXT,buffer:300});this.searchBox.on("keydown",function(a,b){b.getCharCode()==b.ENTER&&b.stopEvent()});this._setSharingSettingsStickyHeader()},this,{single:!0,scope:this});!0!==d?this.serverProxy.getUnsharedPerGroupType(this.folderId,a,""):this.serverProxy.getSharedPerGroupType(this.folderId,
a,"")},_getSharesFromRowElement:function(a,b){var d=Ext.util.JSON.decode(a.query("td.dataCell")[0].innerHTML);d.shareLevel=b;return[d]},_setSharesToRowElement:function(a,b){a.query("td.dataCell")[0].innerHTML=Ext.util.JSON.encode(b)},_activeOnAddedTab:function(a){!0===a?(Ext.get("addedTab").addClass("bolded"),Ext.get("addedTab").removeClass("normal"),Ext.get("addTab").removeClass("bolded"),Ext.get("addTab").addClass("normal")):(Ext.get("addTab").addClass("bolded"),Ext.get("addTab").removeClass("normal"),
Ext.get("addedTab").addClass("normal"),Ext.get("addedTab").removeClass("bolded"))},_setUpActionMenuOnPermissionCell:function(a){var b=a.conditional,d=a.callBackOnMenuChoose,e=a.onDelete;Ext.getBody().on("click",function(a,b){Ext.isDefined(this.accessMenu)&&this.accessMenu.isVisible()&&null===Ext.get(b).findParent(".permissionCell")&&null===Ext.get(b).findParent(".permissionMenu")&&this.accessMenu.hide()},this);Ext.get("sharingView").on("click",function(a,g){if("deleteCell"===a.target.className)return e.call(this,
a,g),!1;var h=Ext.get(g);Ext.isDefined(this.accessMenu)&&this.accessMenu.isVisible()&&null===h.findParent("div.actionMenu")&&this.accessMenu.hide();if(b.call(this,a,g)){var c=h.findParent("tr.baseRow",3);if(null!==c&&(c=Ext.get(c),null!==c&&!0===Ext.util.JSON.decode(c.query("td.dataCell")[0].innerHTML).isPortal))return!1;Ext.isDefined(this.accessMenu)||(this.accessMenu=new Ext.menu.Menu({shadow:!1,id:"permissionMenuId",cls:"actionMenu permissionMenu",items:[{api:"VIEW_",text:Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.LABELS.VIEWER},
{api:"EDIT_ALL_CONTENTS",text:Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.LABELS.EDITOR},{api:"MANAGE",text:Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.LABELS.MANAGER}],setSelectedItem:function(a){for(i=0;i<this.items.length;i++)this.items.get(i).text==a?this.items.get(i).addClass("selectedActionMenuItem"):this.items.get(i).removeClass("selectedActionMenuItem")}},this),this.accessMenu.render(Ext.getBody()));c=h.findParent("td.permissionCell");if(c=Ext.get(c)){var k=Ext.get(c.query(".permissionCellText")[0]);
this.accessMenu.purgeListeners();this.accessMenu.setSelectedItem(k.dom.innerHTML);this.accessMenu.el.setXY([k.getX()-8,k.getY()+16]);this.accessMenu.el.show();this.accessMenu.on("click",function(a,b,c){if(k.dom.innerHTML!=b.text){var e=k.dom.innerHTML;k.dom.innerHTML=b.text;Ext.isDefined(d)&&d.call(this,h,a,b,c,e)}},this)}}},this)},_getDataStoreWithData:function(a){var b=new Ext.data.JsonReader({root:"records",fields:"groupType photoElement shareId shareLevel ugId ugName groupTitle cls shared isPortal ugTitle".split(" ")}),
b=new Ext.data.Store({reader:b});0===a.length&&a.push({cls:"fake",id:"fakeRow",shared:!1,isPortal:!1});b.loadData({records:a});return b},_showWindow:function(a){a.splice(0,0,{xtype:"container",layout:"fit",boxMaxHeight:30,boxMaxWidth:500,id:"folderShareErrorMessageBoxContainer",cls:"message",hidden:!0,items:[{xtype:"label",id:"folderShareErrorMessageBox"}]});this.window.removeAll();this.window.add(a);this.window.doLayout();this.window.show()},_getNewWindowConfig:function(){cancelButton=new Ext.Button({name:"cancel",
text:Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.LABELS.CLOSE,id:"CancelButton",scope:this});var a={layout:"fit",plain:!0,resizable:!1,width:600,height:400,pageX:0.2*Ext.getBody().getViewSize().width,pageY:0.2*Ext.getBody().getViewSize().height,modal:!0,buttons:[cancelButton],buttonAlign:"center",autoHeight:!1,constrain:!0,draggable:!1,header:!0,closable:!0,shadow:!1,id:"sharingWindow",closeAction:"hide",bwrapStyle:"overflow: visible",items:[{xtype:"label",text:"Loading..."}]},b=LC.getLabel("Buttons",
"page_help"),d=b+" "+LC.getLabel("Global","new_window");a.toolTemplate=new Ext.XTemplate("\x3ctpl if\x3d\"id\x3d\x3d'dialogHelp'\"\x3e",'\x3ca href\x3d"javascript:void(null)" onclick\x3d"{href}" class\x3d"helpLink" title\x3d"'+d+'"\x3e\x3cdiv style\x3d"display:inline;" class\x3d"dialogHelpText"\x3e'+b+"\x3c/div\x3e",'\x3cimg class\x3d"helpIcon" src\x3d"/s.gif"/\x3e\x3c/a\x3e',"\x3c/tpl\x3e","\x3ctpl if\x3d\"id!\x3d\x3d'dialogHelp'\"\x3e",'\x3cdiv class\x3d"x-tool x-tool-{id}"\x3e\x26#160;\x3c/div\x3e',
"\x3c/tpl\x3e");a.tools=[];a.tools.push({id:"dialogHelp",href:Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.DIALOG_HELP_URL});return a}});
Ext.namespace("Sfdc.analytics.home");
...
Sfdc.analytics.home.AnalyticsHome.init=function(b,c,d){Ext.getBody().child(".bPageTitle .content").insertSibling(Ext.getBody().child(".addNewButtons"),"after");var e=function(a){Ext.getBody().child(".homeContent span.listViewTitle").update(escapeHTML(a))};Sfdc.analytics.home.EventManager.addListener("folderTreeLoaded",function(a){a=a.getSelectionModel().getSelectedNode().origText;e(a)},this,{scope:this,single:!0});Sfdc.analytics.home.EventManager.addListener("switchFolder",function(a,b,c,d){e(d)});
Sfdc.userAgent.isIE7||(Sfdc.History.onChange(function(a){if(!window.history||!window.history.pushState)Sfdc.analytics.home.AnalyticsHome.HASH_STATE=a}),Sfdc.History.init({usePushState:!0}));Sfdc.analytics.home.AnalyticsHome.USER_PERMS=c;Sfdc.analytics.home.AnalyticsHome.HAS_ENHANCED_SHARING=b;Sfdc.analytics.home.AnalyticsHome.ENHANCED_SHARING_DIALOG_HELP_URL=d};Sfdc.analytics.home.AnalyticsHome.HASH_STATE=null;
Sfdc.analytics.home.AnalyticsHome.initGuidedTour=function(b,c){b||(Sfdc.analytics.home.AnalyticsHome.GUIDED_TOUR=Sfdc.analytics.home.getGuidedTour(c))};Sfdc.analytics.home.AnalyticsHome.startGuidedTour=function(){var b=Sfdc.analytics.home.AnalyticsHome.GUIDED_TOUR;b&&(UserContext.userPreferences.getBoolean("HideAnalyticsHomeGuidedTour")||b.start())};
Sfdc.analytics.home.AnalyticsHome.initAfterPageLoad=function(){Ext.onReady(function(){Ext.getBody().addClass("x-theme-aloha-esque");Sfdc.analytics.home.AnalyticsHome.startGuidedTour();Sfdc.analytics.home.AnalyticsHome.HAS_ENHANCED_SHARING&&Sfdc.analytics.home.sharing.AnalyticsFolderSharingSettings.init(Sfdc.analytics.home.AnalyticsHome.ENHANCED_SHARING_DIALOG_HELP_URL)})};Sfdc.analytics.home.AnalyticsHome.GUIDED_TOUR=null;Sfdc.analytics.home.AnalyticsHome.BOTTOM_BUFFER_SIZE=75;
Ext.namespace("Sfdc.analytics.home");
Sfdc.analytics.home.HomePanel = Ext.extend(Ext.Container, {
    ...
    afterRender: function () {
        Sfdc.analytics.home.HomePanel.superclass.afterRender.apply(this,
            arguments);
