...
Sfdc.provide("SfdcApp.Search.Page", function () {
   ...
   // b.prototype = new SearchPage;
    ...
    b.prototype.isViewingSummary = function () {
        return this.getParam(b.INITIAL_VIEW_MODE) ===
            UnifiedSearchUI.INITIAL_VIEW_MODE_SUMMARY
    };
    ...
    b.prototype.getInitialViewModeForRefreshPage =
        function () {
    ...
    b.prototype.getRefreshPageURL = function (a) {
        ...
        a.asPhrase && c.replace(b.AS_PHRASE,
            a.asPhrase);
    ...
    b.prototype.initGuidedTour = function () {
        var a = this,
            c = Ext.get(UnifiedSearchUI.GUIDED_TOUR_LINK_ID);
    ...
    b.prototype.cacheCurrentView = function () {
        var a = {};
        this.isViewingFeeds() ? (a[b.FEEDS_CMP] = Ext.get(b.SEARCH_BODY_ID).dom.innerHTML, this.updateCache(this.getState(), a)) : this.isViewingSummary() && (a[b.SUMMARY_CMP] = Ext.get(b.SEARCH_BODY_ID).dom.innerHTML, a[b.SIDETABS_CMP] = Ext.get(UnifiedSearchUI.SIDETABS_ID).dom.innerHTML,
            this.updateCache(this.getState(), a))
    };
    ...
    b.prototype.initSearchMoreOptions = function () {
        ...
        if (c) {
            ...
            if (Ext.isIE7 && (d = Ext.get("moreOptionsDivisions"))) {
                d = d.dom.options;
                for (e = 0; e < d.length; e++) d[e].title =
                    d[e].text
            }
        }
    };
    ...
    b.prototype.getKeyPrefixForItemLink =
        function (a) {
    ...
    b.prototype.showOrHideSearchMoreObjsHeadingSeparator = function () {
        if (!this.isDefaultToSearchAll) {
            ...
            0 ===
                a.getCount() || 0 === b.getCount() ? this.hideSearchMoreObjsHeadingSeparator() : this.showSearchMoreObjsHeadingSeparator()
        }
    };
    ...
    b.prototype.moveToTopBySteps = function (a) {
        ...
        this.log("moveToTopBySteps steps calculated: " +
            b.length);
    ...
    b.prototype.mouseOverItemLink = function (a) {
        ...
        this.pinnedMap[c] ? (a.removeClass(b.ITEM_PINNED), a.addClass(b.ITEM_PINNED_HOVER)) : (a.removeClass(b.ITEM_UNPINNED),
            a.addClass(b.ITEM_UNPINNED_HOVER))
    };
    ...
    b.prototype.log = function (a) {
        "undefined" != typeof console && "undefined" !=
            typeof console.info && console.info(a)
    };
    ...
    b.prototype.getSecondSearchBoxInputTitleByScope = function () {
        ...
        return a ? a.dom.getAttribute("title") :
            "Search box title is not found"
    };
    ...
    b.prototype.updateSecondSearchBoxTitleAndScope = function (a, b) {
        Ext.get(UnifiedSearchUI.SECOND_SEARCH_TEXT_ID).dom.setAttribute("title",
            a);
    ...
    b.prototype.successCallBackDrilldown = function (a) {
        ...
        var c = this.normalize(this.getSearchStr()) !== this.lastSidetabQuery,
            d = this.getParam("collapse");
    ...
    b.prototype.updateHistoryState = function (a) {
        ...
        this.closeGuidedTour();
        Sfdc.History.isBrowserSupported() ? Sfdc.History.replace(a) : (this.lastState = this.currentState || Sfdc.clone(this.initialState, !0), this.currentState = a, this.setComponents(),
        ...
        if (e) this.handleResponse(e, a), e[UnifiedSearchUI.FIRST_PAGE_QUERY_ID_OVERRIDE] && (this.firstPageQueryIdOverride = e[UnifiedSearchUI.FIRST_PAGE_QUERY_ID_OVERRIDE]);
            ...
            Ext.Ajax.request({
                ...
                failure: function (a) {
                    ...
                    f.notifyFailure(a);
                    c && c();
                    Sfdc.Aria.notify(LC.getLabel("Page_UnifiedSearch",
                        "searchingFailed"))
                }
            })
        }
    ...
    b.prototype.updateCache = function (a, b) {
        if (a && b) {
            var d = this.normalize(a.str),
                e = this.cache[d];
            e || (e = {}, this.cache[d] = e);
            var d = this.getCacheKey(),
                f = e[d];
            f || (f = {}, e[d] = f);
    ...
    b.prototype.updateSecondSearchBox = function (a) {
        Ext.get(UnifiedSearchUI.SECOND_SEARCH_TEXT_ID).dom.value != a && (Ext.get(UnifiedSearchUI.SECOND_SEARCH_TEXT_ID).dom.value =
            a)
    };
    ...
    b.prototype.updateInnerHTML = function (a, c) {
        if (!a || !a.dom) return a;
        var d = ["UnifiedSearchPage.updateInnerHTML start:",
            this.getParam(b.INITIAL_VIEW_MODE), a.id
        ].join(" ");
        Perf.mark(d);
        var e = a.dom;
        e.innerHTML = c || "";
    ...
    b.prototype.selectEntityInSummaryListView =
        function (a) {
