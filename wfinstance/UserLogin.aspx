...
<body>
    ...
    <div>
        ...
        <table>
            <tr>
                ...
                <td ><input type="text" id="username" name="username"   class="easyui-textbox"  style="width:200px;"  /></td>
            </tr>
             <tr>
                <td style="text-align:right">密码:</td>
                <td><input id="pwd"  class="easyui-passwordbox"   style="width:200px;" />
                </td>
            </tr>
        </table>
        ...
        <div><p>
            <input type="button" id="btnSave"  name="btnSave" value="确认" onclick="validate()"  />
    ...
    <script>
        ...
        function validate() {
            ...
            var url = "oa.user.login.validation";
        ...
        function validateSuccess()
        {
            ...
            var url = "/apps/RecDetail.aspx?t=" + t + "&id=" + id;
            window.open(url);
