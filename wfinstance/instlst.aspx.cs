...
{
    public partial class instlst : System.Web.UI.Page
    {
        CallContext _caller;
        int _pageSize = 25;
        string _initJson = "";
        ...
        public void GetEntityList()
        {
            ...
            WFInstanceGridRender relatedEntityListRenderer = new WFInstanceGridRender();
            relatedEntityListRenderer.GridConfigId = gridid;
            ...
            string loadUrl = string.Format("/_ui/gridx/list/ListServlet?gridid={0}&showAction=0", gridid);
            _initJson = "new LineItemListViewport('lineItemView', 'PricebookEntry'," + dataJson + ", '80190000000PJyk', '" + loadUrl + "');";
        }
