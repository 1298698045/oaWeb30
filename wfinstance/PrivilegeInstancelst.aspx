...
<head>
    ...
    <title>分权事务查询 - 事务管理 - 流程管理 ~  - 协同办公系统</title>
    ...
    <style type="text/css">
        ...
        .header-left-title .fixed-list{
            display:none !important;
        }
        .header-left-title .header-left-title-listname.selectinput>img{
            display:none !important;            
        }
        .header-left-title .selectlist.selectlistcheck{
            display:none !important;            
        }
        .viewlist{
            opacity:0.5;
    ...
    <style>
        ...
        .header-right-buttonbtn .shuaxin img{
            width:14px;
            position:relative;
            top:8px;
            right:6px;
...
<body onunload="if(this.bodyOnUnload)bodyOnUnload();" onbeforeunload="if(this.bodyOnBeforeUnload){var s=bodyOnBeforeUnload();if(s)return s;}" onload="if(this.bodyOnLoad)bodyOnLoad();" class="hasMotif contactTab   ext-gecko ext-gecko3 sfdcBody brandQuaternaryBgr" onfocus="if(this.bodyOnFocus)bodyOnFocus();">
                        ...
                        <div id="bodyWrapper">
                            ...
                            <div class="miss-header">
                                ...
                                <div class="header-left-title">
                                    <p class="header-left-title-name">分权事务管理</p>
                                    <p class="header-left-title-listname selectinput"><span>有权限查询的</span><img src="/img/cal/20.png" alt="" /></p>
                                ...
                                <div class="header-right-buttonbtn">
                                    ...
                                    <div style="border: 1px solid #dddbda; height: 30px;line-height:30px;">
                                        <select style="height: 30px;line-height:25px;font-size:12px;color: #333;" id="StateCode" name="StateCode" onchange="GridInstancesearch()">
                                    ...
                                    <div
                                        ...
                                        <div class="selectlist selectlistcheck">
                                            <ul>
                                                <li value="100" class="active"><img src="/img/cal/checkedgrey.png" /><span>全部</span></li>
                                                <li value="0"><img src="/img/cal/checkedgrey.png" /><span>一般</span></li>
                                                <li value="1"><img src="/img/cal/checkedgrey.png" /><span>紧急</span></li>
                                                <li value="2"><img src="/img/cal/checkedgrey.png" /><span>加急</span></li>
                                            </ul>
                                       </div>
                                    </div>
                                    <div>
                                    ...
                                    <script>
                                        ...
                                        function GridInstancesearch() {
                                            var CreatedBy = $("#createdby_lkid").val();
                                            var BusinessUnitId = $("#DeptId_lkid").val();
                                            ...
                                            var Priority = $('#Priority .active').attr('value')
                                            if ((Priority && Priority != '' && Priority != '100') || Priority === 0 || Priority === '0') {
                                                queryPara += "\nPriority\teq\t" + Priority;
                                            }
                                            var treenode = $('#leftTree').tree('getSelected')
                                            if (treenode) {
                                                var treenode = $('#leftTree').tree('getData', treenode.target)
                                                var treenodeid = treeNode.getchildrendata(treenode)
                                                if (treenode != null) {
                                                    queryPara += "\nProcessId\tin\t" + treenodeid
                                                }
                                            }
                                            queryPara = queryPara.slice(1)
                                            bindGrid(queryPara, "");
                            ...
                            <div class="table-body">
                                <div class="objectManagerLeftNav" style="padding-top: 0; height: 100%; padding-bottom: 0;">
                                    ...
                                    <div id="tb" style="height: auto">
                                        ...
                                        <!--<a href="javascript:processList(3)" class="easyui-linkbutton" data-options="iconCls:'icon-undo',plain:true">结束</a>
                                        ...
                                        <a href="javascript:processList(0)" class="easyui-linkbutton" data-options="iconCls:'icon-toExcel',plain:true" onclick="exportWfInstanceDownload()">导出</a>
                                        <a href="javascript:processList(0)" class="easyui-linkbutton" data-options="iconCls:'icon-print',plain:true" onclick="printInstanceForm()">打印</a>
                                ...
                                <script>
                                    ...
                                    function bindGrid(Query, search) {
                                        ...
                                        fcols.push(col);
                                        fcols.push({ field: "ProcessInstanceNumber", title: '流程编号' });
                                        fcols.push({ field: "Name", title: '标题', formatter: formatName });
                                        ...
                                        fcols.push({ field: "AttachQty", title: '附件数量', sortable: true });                                        
                                        ...
                                        fcols.push({ field: "PriorityName", title: '紧急程度', sortable: true });
                                        //被考评部门
                                        url = "/apps/CommandProcessor.ashx?cmd=process.instance.privilege.search";
                                        if (!search)
                                            search = "";
                                        $('#datagrid').datagrid({
                                            url: url,
                                ...
                                <script type="text/javascript">
                                    ...
                                    function formatName(val, row, index, entityType) {
                                        ...
                                        var html = '<a style=\"color:#015ba7;font-size:13px;\" target=\"_blank\" href="/122/detail?id=' + rowId + '">' + instanceName + '</a>';
                                        return html;
                                    }
                                    ...
                                    function formatOper(val, row, index, entityType) {
                                        ...
                                        var fromActivityId = row.CurrentStepId;
                                        //return '<a style=\"color:#015ba7;font-size:13px;\" href="e?id=' + rowId + '">修改</a>&nbsp;|&nbsp;<a style=\"color:#015ba7;font-size:13px;\" href=\"/setup/own/deleteRedirect.aspx?objectType=&delID=' + rowId + '&retURL=\">删除</a>';
                                        ...
                                        //alert(state);
                                        var retURL = "%2fui%2fprocess%2finstance%2fInstanceHome"
                                        if (state == "1" || state == "5") {
                                            ...
                                            html += "&nbsp;|&nbsp;<a style=\"color:#015ba7;font-size:13px;\" href=\"/WFPageProcessor.ashx?cmd=cancelwfinstance&amp;id=" + rowId + "&retURL=" + retURL + "\" onclick=\"return confirmCancelWF();\">撤销</a>";
                                            html += "&nbsp;|&nbsp;<a style=\"color:#015ba7;font-size:13px;\" href=\"/WFPageProcessor.ashx?cmd=finishwfinstance2&amp;id=" + rowId + "&retURL=" + retURL + "\" onclick=\"return confirmFinishWF();\">结束</a>";
                                        }
                                        if (state == "3")
                                            html += "&nbsp;|&nbsp;<a style=\"color:#015ba7;font-size:13px;\" onclick=\"javascript:insertProcess('" + rowId + "')\" >加签</a>&nbsp;";
                                    ...
                                    function printInstanceForm() {
                                        var row = $('#datagrid').datagrid('getChecked')
                                        if (row.length > 0) {
                                            var ids = []
                                            for (var i = 0; i < row.length; i++) {
                                                ids.push(row[i].ProcessInstanceId)
                                            }
    ...
    <script>
        ...
        function exportWfInstanceDownload() {
            var name = '流程事务模块';
            var exportfilename = '流程事务模块导出';
            var professname = $('#leftTree').tree('getSelected').text;
            var objecttypecode = 128;
            var n = "/apps/HrProcessor.ashx?cmd=wf.instance.export&ProcessName=" + professname + "&ObjectTypecode=" + objecttypecode + "&ExportFileName=" + exportfilename;
            window.open(n);
            return false;
        }
    ...
    <script>
        ...
        $('#createdby').click(function () {
            opencenterwindow('/_ui/common/data/UserLookResult.aspx?lkfm=editPage&lknm=createdby&lktp=' + getElementByIdCS('createdby_lktp').value,'',1000,600)
         })
        $('#DeptId').off()
        $('#DeptId').click(function () {
            opencenterwindow('/_ui/common/data/DeptLookResult.aspx?lkfm=editPage&lknm=DeptId&lktp=' + getElementByIdCS('DeptId_lktp').value, '', 1000, 600)
        })
