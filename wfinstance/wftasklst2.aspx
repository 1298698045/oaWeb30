...
<head>
    ...
    <title>事务管理 - 流程管理 ~  - 协同办公管理系统</title>
    ...
    <style>
        ...
        .tab-item.active{
            border-bottom:1px solid #108def;
            color:#108def;
        }
    </style>
</head>
<body onunload="if(this.bodyOnUnload)bodyOnUnload();" onbeforeunload="if(this.bodyOnBeforeUnload){var s=bodyOnBeforeUnload();if(s)return s;}" onload="if(this.bodyOnLoad)bodyOnLoad();" class="hasMotif contactTab   ext-gecko ext-gecko3 sfdcBody brandQuaternaryBgr" onfocus="if(this.bodyOnFocus)bodyOnFocus();">
                        ...
                        <div id="bodyWrapper">
                            ...
                            <div class="miss-header">
                                ...
                                <div class="header-left-title">
                                    <p class="header-left-title-name">待办事务</p>
                                </div>
                                ...
                                <div class="header-right-buttonbtn">
                                    ...
                                    <div
                                        ...
                                        <div class="selectlist selectlistcheck">
                                            <ul>
                                                <li value="-1" class="active"><img src="/img/cal/checkedgrey.png" /><span>全部</span></li>
                                    ...
                                    <div class="buttonbtn-group">
                                        <div class="buttonbtn" onclick="GridInstancesearch(false)"><a href="javascript:void(0)">搜索</a></div>
                                    </div>
                                    <div class="buttonbtn-group">
                                        <div class="buttonbtn" onclick="clearsearck()"><a href="javascript:void(0)">重置</a></div>
                                    </div>
                            ...
                            <div class="table-body">
                                <div class="objectManagerLeftNav" style="padding-top: 0; height: 100%; padding-bottom: 0;">
                                    ...
                                    <div style="float:left;">
                                        <div class="tabs-nav">
                                            <div class="tab-item active">全部 (21)</div>
                                            <div class="tab-item">待处理 (3)</div>
                                            <div class="tab-item">待阅 (3)</div>
                                            <div class="tab-item">被退回 (3)</div>
                                            <div class="tab-item">被督办 (3)</div>
                                        </div>
                                    </div>
                                    <div id="gridContainer">
                                        
                                        <table id="datagrid" class="easyui-datagrid"data-options="fitColumns:true,singleSelect:true,autoWidth:true,pagination:true,rownumbers: true,toolbar: '#tb'">
                                            <tr>
                                    ...
                                    <div id="tb" style="height: auto">
                                        ...
                                        <a class="easyui-linkbutton" data-options="iconCls:'icon-print',plain:true" onclick="printInstanceForm()">打印</a>
                                 ...
                                 <script type="text/javascript">
                                        function GridInstancesearch(isStarted) {
                                            ...
                                            if (!isStarted) {
                                                if ($('#leftTree').tree('getSelected')) {
                                                    ...
                                                    if (treenodeid && treenodeid != '') {
                                                        queryPara += "ProcessId\tin\t" + treenodeid;
                                                    }
                                                }
                                            }
                                            ...
                                            if ((Priority && Priority != '' && Priority != '-1') || Priority === 0 || Priority === '0') {
                                ...
                                <script type="text/javascript">
                                    ...
                                    function formatName(val, row, index, entityType) {
                                        ...
                                        var html = '<a style=\"color:#015ba7;font-size:13px;\" target=\"_blank\" href="/122/detail?source=i&id=' + rowId + '&retURL=%2f122%2fo">' + instanceName + '</a>';
                                        return html;
                                    }
                                    ...
                                    function printInstanceForm()
                                    {
                                        ...
                                        if (row.length > 0) {
                                            for (var i = 0; i < row.length; i++) {
                                                window.open('/apps/wf/WFFormPrint.aspx?InstanceId=' + row[i].ProcessInstanceId,i)
                                            }
                                        } else {
                                            alert('请先选择行')
                                        }
    ...
    <script>
        ...
        function clearsearck() {
            $('#srchText').val('')
            $('#StateCode').val('')
            $('#Priority .selectinput span').html('全部')
            $('#Priority li').removeClass('active')
            $('#Priority li').eq(0).addClass('active')
            $('#createdby_lkid').val('')
            $('#createdby').val('')
            $('#DeptId').val('')
            $('#DeptId_lkid').val('')
            $('[name="StartTime"]').attr('value', '')
            $('[name="StartTime"]').find('input').val('')
            $('[name="EndTime"]').attr('value', '')
            $('[name="EndTime"]').find('input').val('')
        }
    </script>
