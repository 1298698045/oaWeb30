...
{
    public partial class formdatalst : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ProcessDefinition pd = WfSchemeManager.GetProcess(new Guid(processId));
            _objectTypeCode = pd.EntityType;
            _template = TemplateManager.GetTemplate(_caller.OrganizationId, _objectTypeCode);
            if (_template != null)
            {
                this._templateCode = entityType;
                _objectTypeCode = _template.ObjectTypeCode;
        ...
        public void GetEntityList()
        {
            ...
            string queryURL = "/_ui/entity/SearchEntityListServlet?showAction=0&actionCol=no&templateid=" + _tmeplateId;
        ...
        public int TypeCode { set { _objectTypeCode = value; } get { return _objectTypeCode; } }
