...
<body>
    ...
    <div>
        ...
        <table>
            <tr>
                <td>序号:</td>
                <td><input id="SortNumber" class="easyui-numberspinner" value="0" data-options="increment:1" style="width:150px;" /></td>
            </tr>
            <tr>
                <td>意见</td>
                <td>
        ...
        <div><p>
            <input type="button" id="btnSave"  name="btnSave" value="保存" onclick="DataSave()"  />
    ...
    <script>
        ...
        $(function () {
            ...
            if (id != null) {
                var SortNumber = getQueryString('SortNumber');
                var Name = getQueryString('Name');
                $("#SortNumber").numberspinner("setValue", SortNumber);
        ...
        function DataSave() {
            ...
            var id = getQueryString('id');
            var SuggestionType = '0'; //0私有 1公用
            var SortNumber = $('#SortNumber').numberspinner('getValue');
