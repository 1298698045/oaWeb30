...
<head>
    ...
    <title>草稿箱 - 我的事务  - 流程管理 - 高效协同</title>
...
<body onunload="if(this.bodyOnUnload)bodyOnUnload();" onbeforeunload="if(this.bodyOnBeforeUnload){var s=bodyOnBeforeUnload();if(s)return s;}" onload="if(this.bodyOnLoad)bodyOnLoad();" class="hasMotif eventTab   ext-gecko ext-gecko3 sfdcBody brandQuaternaryBgr" onfocus="if(this.bodyOnFocus)bodyOnFocus();">
    ...
    <script type="text/javascript">
        ...
        function LoadGridData() {
            ...
            cols.push({ field: "ProcessInstanceNumber", width: 130, title: '流程编号' });
            cols.push({ field: "Name", width: 500, title: '标题', sortable: true, formatter: formatName });
            cols.push({ field: "ProcessIdName", width: 200, title: '流程名称', sortable: true });
            cols.push({ field: "StateCodeName", title: '状态', sortable: true });
            cols.push({ field: "BusinessUnitIdName", title: '部门', sortable: true });
            cols.push({ field: "CreatedByName", title: '创建人姓名', sortable: false });
            cols.push({ field: "CreatedOn", width: 140, title: '创建时间', sortable: true });
            cols.push({ field: "ModifiedOn", width: 140, title: '上次一次修改时间', sortable: true });
            var url = "/apps/CommandProcessor.ashx?cmd=wf.instanceowner.search";
