<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wftasklst.aspx.cs" Inherits="WebClient.wfinstance.wftasklst" %>
...
<head>
    ...
    <title>待办事务 : 我的事务 ~ 流程管理 - 协同办公系统</title>
    ...
    <script>
        $(document).ready(function () {
            if (getQueryString('tab') == '1') {
                location.href = '/wfinstance/fowardReadLog.aspx?gridid=myreadwfinstances&amp;t=a0M'
            }
            else if (getQueryString('tab') == '2') {
                location.href = '/wfinstance/cancellst.aspx?gridid=cancelledWfinstances&amp;t=a0M'
            }
        })
    </script>
</html>
