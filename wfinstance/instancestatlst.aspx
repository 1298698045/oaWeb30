...
<body onunload="if(this.bodyOnUnload)bodyOnUnload();" onbeforeunload="if(this.bodyOnBeforeUnload){var s=bodyOnBeforeUnload();if(s)return s;}" onload="if(this.bodyOnLoad)bodyOnLoad();" class="hasMotif eventTab   ext-gecko ext-gecko3 sfdcBody brandQuaternaryBgr" onfocus="if(this.bodyOnFocus)bodyOnFocus();">
        ...
        <div class="bodyDiv brdPalette brandPrimaryBrd">
            <div class="subNav" style="width: 100%; height: 35px; background-color: #fff; margin: 0px; margin-top: 10px; border-bottom: 1px dotted #E9E9E9; line-height: 23px; font-size: 13px; margin-bottom: 5px;">
                <div style="width: 100%; height: 30px;">
                    ...
                    <a id="mydraftinstances" href="/wfinstance/draftlst.aspx?gridid=mydraftinstances&t=a0M" class="subNav-tab  subNav-tab-active">
                    ...
                    <a id="instancestat" href="/wfinstance/instancestatlst.aspx?t=a0M" class="subNav-tab">
            ...
            <table class="outer" width="100%" id="bodyTable" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td class="oRight" id="bodyCell">                   
                        <div id="bodyWrapper">
                            <div class="mission-header mission-header1">
                                <div class="mission-hearder-right">
                                    ...
                                    <p class="sousuo">
                                      <input type="text" placeholder="请输入流程名" id="srchText" name="srchText" class="searchtext" />
                                    </p>
                                     <p class="sousuo">
                                      <input type="text" placeholder="请输入创建人" id="CreatedBy" name="CreatedBy" class="searchtext" />
                                    </p>
                                    <p style="cursor: Default;width: auto;padding: 0 10px;">
                                   结束时间 <input type="date" id="ProcessEnd" name="ProcessEnd"  />
                                    </p>
                                    <p style="cursor: Default;width: auto;padding: 0 10px;" >
                                    开始时间   <input type="date" id="ProcessStart" name="ProcessStart" />
                                    </p>
                                    <%-- 
                        ...
                        <div class="clear"></div>
                        <div>
                            <div class="objectmanagerleftnav" style="padding-top: 0;  padding-bottom: 0;"></div>
                 ...
                 <%--           <div id="tb">
                            ...
                            <div id="gridcontainerleft" style="margin-left:5px;margin-right:5px;" data-options="">
    ...
    <script type="text/javascript">
        ...
        function LoadGridData() {
            var url = "/apps/CommandProcessor.ashx?cmd=process.instance.stat";
           
            var filterQuery = 'StateCode\teq\t0';
            var search = $('#srchText').val();
            if (search != '') {
                url += "&ProcessName=" + search;
            }
            var CreatedBy = $('#CreatedBy').val();
            if (CreatedBy != '') {
                url += "&CreatedBy=" + CreatedBy;
            }
            var ProcessStart = $('#ProcessStart').val();
            if (ProcessStart != '') {
                url += "&ProcessStart=" + ProcessStart;
            }
            var ProcessEnd = $('#ProcessEnd').val();
            if (ProcessEnd != '') {
                url += "&ProcessEnd=" + ProcessEnd;
            }
           ...
           cols.push({ field: "ProcessName", width:'800', title: '流程名称', sortable: true });
           cols.push({ field: "counts", width:'940',title: '数量', sortable: true });
        ...
        function formatOper(val, row, index, entityType) {
            var rowId = row.ProcessInstanceId;
            var action = "<a style=\"color:#015ba7;font-size:13px;\" href=\"/a0M/e?source=i&id=" + row.ProcessInstanceId + "&retURL=%2fwfinstance%2fdraftlst.aspx%3fgridid%3dmydraftinstances%26t%3da0M\">修改</a>";
