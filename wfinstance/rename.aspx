...
<body>
    ...
    <div>
        ...
        原名称: <input type="text" id="OldName" name="OldName" value="<%=Request["Name"]%>" style="width:350px;height:25px;" disabled="disabled"  />
...
<br/>
 <div>
        ...
        新名称: <input type="text" id="NewName" name="NewName" value="" style="width:350px;height:25px;"   />
    </div>
    ...
    <script>
        ...
        function validateSave() {
            ...
            ajaxMethodData("workflow.rename", d, renameSuccess);
