<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="formdatalst.aspx.cs" Inherits="WebClient.wfinstance.formdatalst" %>
...
<head>
    ...
    <style>
        ...
        #lineItemView_subNav .linkBar.brandSecondaryBrd{
...
<body onload="if(this.bodyOnLoad)bodyOnLoad();" onunload="if(this.bodyOnUnload)bodyOnUnload();"
    class="hasMotif  sfdcBody brandQuaternaryBgr" onfocus="if(this.bodyOnFocus)bodyOnFocus();"
            ...
            <table class="outer" width="100%" id="bodyTable" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td class="oRight" id="bodyCell">
                        ...
                        <script src="/workspaces/folderOpration.js"></script>
                        ...
                        <form action="/_ui/entity/search/EntitySearchResults" id="editPage" method="post"    name="editPage" onsubmit="if (window.ffInAlert) { return false; }">
                                                    ...
                                                    <tr>
                                                        <td valign="top" colspan="2">
                                                            <div class="searchFilterButtons productButtons">
                                                                ...
                                                                <input type="button" title="另存为" onclick="document.getElementById('isSaveAs').value = '1'; return exportDownload();" name="save" class="btn" value=" 导出另存为 " data-uidsfdc="6" />
                            ...
                            <!-- Body events -->
                              ...
                              <script type="text/javascript" >
                                  ...
                                  function lookupPick3(lknm, id, name) {
                                      jQuery("#"+lknm+ "_lkid").val(id);
                                      jQuery("#" + lknm).val(name);
                                  }
                                  $(function () {
                                      if (jQuery("#srt_CreatedOn").length > 0) {
                                          jQuery("#srt_CreatedOn").attr('onblur', 'console.log("srt_CreatedOn")')
                                      }
                                      if (jQuery("#end_CreatedOn").length > 0) {
                                          jQuery("#end_CreatedOn").attr('onblur', 'console.log("end_CreatedOn")')
                                      }
                                  });
