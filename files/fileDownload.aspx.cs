        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else if ( fileType == "log")
                {
                    ...
                    filePath = ImportDataUtil.ImportLogFilePath + "\\" + fileName + ".txt";
                    DownloadFile(filePath, fileName+".txt");
                }
                else
                {
                ...
                fileLog.BrowserName = GetBrowser();
                fileLog.ModifiedBy = _caller.UserID;
                fileLog.ModifiedOn = DateTime.Now.ToString("yyyy-MM-dd");
                ...
                fileLog.CreatedBy = _caller.UserID;
                fileLog.CreatedOn = DateTime.Now.ToString("yyyy-MM-dd");
