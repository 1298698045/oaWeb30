<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FilterLookupPage.aspx.cs" Inherits="WebClient.filter.FilterLookupPage" %>
...
<body onload="if(this.bodyOnLoad)bodyOnLoad();" onunload="if(this.bodyOnUnload)bodyOnUnload();" class="hasMotif lookupTab  FilterLookupPage" onfocus="if(this.bodyOnFocus)bodyOnFocus();" onbeforeunload="if(this.bodyOnBeforeUnload){var s=bodyOnBeforeUnload();if(s)return s;}">
    ...
    <div class="lookup">
        ...
        <div class="topButton">
            <input value=" 插入所选 " class="btn" name="Done" onclick="FilterLookupPage.prototype.transfer(false);" title="插入所选" type="button" /></div>
        ...
        <div class="bottomButton">
            <input value=" 插入所选 " class="btn" name="Done" onclick="FilterLookupPage.prototype.transfer(false);" title="插入所选" type="button" /></div>
        <div class="footer">&copy; 2000-2015 .com, inc. 公司版权所有。 本公司保留所有权利。</div>
    </div>
