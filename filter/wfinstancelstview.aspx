...
<body onunload="if(this.bodyOnUnload)bodyOnUnload();" onbeforeunload="if(this.bodyOnBeforeUnload){var s=bodyOnBeforeUnload();if(s)return s;}" onload="if(this.bodyOnLoad)bodyOnLoad();" class="hasMotif contactTab  overviewPage sfdcBody brandQuaternaryBgr   ext-gecko ext-gecko3" onfocus="if(this.bodyOnFocus)bodyOnFocus();">
                        ...
                        <div class="miss-header">
                            ...
                            <div class="header-right-buttonbtn">
                                <div class="buttonbtn-group">
                                    <div class="buttonbtn"><a id="approval">发起流程</a></div>
                                    <div class="buttonbtn"><a class="new-btn" id="newbtn">新建</a></div>
                                </div>
                            </div>
                            <div class="header-right-buttonbtn">
    ...
    <script>
        function formatOper(val, row, index, entityType) {
            ...
            var html = '<a style=\"color:#015ba7;font-size:13px;\" href="/' + entityType + '/detail?objectTypeCode=' + webContext.objectTypeCode + '&id=' + rowId + '">查看</a>&nbsp;';
            html += ' | <a style=\"color:#015ba7;font-size:13px;\" href="/a0M/e?id=' + rowId + '&source=l&retURL=%2f123%2fo">审批单</a>&nbsp;';
            return html
        }
        ...
        $('#approval').click(function () {
            $('.popup-mask').show()
            $('#iframe').attr('src', '/alert/wf/instanceCreate.html').height(520).show().css('margin-top', '-270px')
        })
    </script>
